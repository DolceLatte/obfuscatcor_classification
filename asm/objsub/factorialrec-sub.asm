...
./sub//factorialrec-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40053d:	e8 2e 00 00 00       	callq  400570 <fact>
  400542:	48 bf 54 06 40 00 00 	movabs $0x400654,%rdi
  400549:	00 00 00 
...
0000000000400570 <fact>:
  400570:	55                   	push   %rbp
  400571:	48 89 e5             	mov    %rsp,%rbp
  400574:	48 83 ec 10          	sub    $0x10,%rsp
  400578:	89 7d f8             	mov    %edi,-0x8(%rbp)
  40057b:	83 7d f8 01          	cmpl   $0x1,-0x8(%rbp)
  40057f:	0f 85 0c 00 00 00    	jne    400591 <fact+0x21>
  400585:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
  40058c:	e9 28 00 00 00       	jmpq   4005b9 <fact+0x49>
  400591:	8b 45 f8             	mov    -0x8(%rbp),%eax
  400594:	8b 4d f8             	mov    -0x8(%rbp),%ecx
  400597:	81 e9 21 e8 60 d0    	sub    $0xd060e821,%ecx
  40059d:	83 e9 01             	sub    $0x1,%ecx
  4005a0:	81 c1 21 e8 60 d0    	add    $0xd060e821,%ecx
  4005a6:	89 cf                	mov    %ecx,%edi
  4005a8:	89 45 f4             	mov    %eax,-0xc(%rbp)
  4005ab:	e8 c0 ff ff ff       	callq  400570 <fact>
  4005b0:	8b 4d f4             	mov    -0xc(%rbp),%ecx
  4005b3:	0f af c8             	imul   %eax,%ecx
  4005b6:	89 4d fc             	mov    %ecx,-0x4(%rbp)
  4005b9:	8b 45 fc             	mov    -0x4(%rbp),%eax
  4005bc:	48 83 c4 10          	add    $0x10,%rsp
  4005c0:	5d                   	pop    %rbp
  4005c1:	c3                   	retq   
