...
./sub//1b-4-2-0-0-dc-2-1-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	0f 8d 63 00 00 00    	jge    400593 <main+0x93>
  ...
  400547:	0f 8f 29 00 00 00    	jg     400576 <main+0x76>
  40054d:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400550:	8b 4d e4             	mov    -0x1c(%rbp),%ecx
  400553:	81 c1 a8 cb 36 0a    	add    $0xa36cba8,%ecx
  400559:	01 c1                	add    %eax,%ecx
  40055b:	81 e9 a8 cb 36 0a    	sub    $0xa36cba8,%ecx
  400561:	89 4d e4             	mov    %ecx,-0x1c(%rbp)
  400564:	31 c0                	xor    %eax,%eax
  400566:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  400569:	83 e8 01             	sub    $0x1,%eax
  40056c:	29 c1                	sub    %eax,%ecx
  40056e:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  400571:	e9 c1 ff ff ff       	jmpq   400537 <main+0x37>
  400576:	e9 00 00 00 00       	jmpq   40057b <main+0x7b>
  40057b:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40057e:	05 18 96 b7 d4       	add    $0xd4b79618,%eax
  400583:	83 c0 01             	add    $0x1,%eax
  400586:	2d 18 96 b7 d4       	sub    $0xd4b79618,%eax
  40058b:	89 45 ec             	mov    %eax,-0x14(%rbp)
  40058e:	e9 91 ff ff ff       	jmpq   400524 <main+0x24>
  400593:	48 bf 44 06 40 00 00 	movabs $0x400644,%rdi
  40059a:	00 00 00 
  40059d:	8b 75 e4             	mov    -0x1c(%rbp),%esi
  4005a0:	b0 00                	mov    $0x0,%al
  4005a2:	e8 59 fe ff ff       	callq  400400 <printf@plt>
  4005a7:	31 f6                	xor    %esi,%esi
  4005a9:	89 45 e0             	mov    %eax,-0x20(%rbp)
  4005ac:	89 f0                	mov    %esi,%eax
  4005ae:	48 83 c4 20          	add    $0x20,%rsp
  4005b2:	5d                   	pop    %rbp
  4005b3:	c3                   	retq   
