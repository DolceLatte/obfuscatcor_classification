...
./sub//1b-4-1-1-0-dc-1-1-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400527:	48 bf 34 06 40 00 00 	movabs $0x400634,%rdi
  40052e:	00 00 00 
  ...
  400542:	e9 60 00 00 00       	jmpq   4005a7 <main+0xa7>
  400547:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
  40054e:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400551:	3b 45 f8             	cmp    -0x8(%rbp),%eax
  400554:	0f 8d 2f 00 00 00    	jge    400589 <main+0x89>
  40055a:	31 c0                	xor    %eax,%eax
  40055c:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40055f:	8b 55 e8             	mov    -0x18(%rbp),%edx
  400562:	89 c6                	mov    %eax,%esi
  400564:	29 d6                	sub    %edx,%esi
  400566:	89 c2                	mov    %eax,%edx
  400568:	29 ca                	sub    %ecx,%edx
  40056a:	01 d6                	add    %edx,%esi
  40056c:	29 f0                	sub    %esi,%eax
  40056e:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400571:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400574:	05 b5 b9 17 17       	add    $0x1717b9b5,%eax
  400579:	83 c0 01             	add    $0x1,%eax
  40057c:	2d b5 b9 17 17       	sub    $0x1717b9b5,%eax
  400581:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400584:	e9 c5 ff ff ff       	jmpq   40054e <main+0x4e>
  400589:	48 bf 4e 06 40 00 00 	movabs $0x40064e,%rdi
  400590:	00 00 00 
  400593:	8b 75 e8             	mov    -0x18(%rbp),%esi
  400596:	b0 00                	mov    $0x0,%al
  400598:	e8 63 fe ff ff       	callq  400400 <printf@plt>
  40059d:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  4005a4:	89 45 e0             	mov    %eax,-0x20(%rbp)
  4005a7:	8b 45 fc             	mov    -0x4(%rbp),%eax
  4005aa:	48 83 c4 20          	add    $0x20,%rsp
  4005ae:	5d                   	pop    %rbp
  4005af:	c3                   	retq   
