...
./sub//1b-4-1-0-0-dc-2-1-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	0f 8d 2f 00 00 00    	jge    40055f <main+0x5f>
  400530:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400533:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  400536:	81 c1 3e ed ff 78    	add    $0x78ffed3e,%ecx
  40053c:	01 c1                	add    %eax,%ecx
  40053e:	81 e9 3e ed ff 78    	sub    $0x78ffed3e,%ecx
  400544:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  400547:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40054a:	05 29 19 35 da       	add    $0xda351929,%eax
  40054f:	83 c0 01             	add    $0x1,%eax
  400552:	2d 29 19 35 da       	sub    $0xda351929,%eax
  400557:	89 45 ec             	mov    %eax,-0x14(%rbp)
  40055a:	e9 c5 ff ff ff       	jmpq   400524 <main+0x24>
  40055f:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
  400566:	83 7d ec 04          	cmpl   $0x4,-0x14(%rbp)
  40056a:	0f 8f 29 00 00 00    	jg     400599 <main+0x99>
  400570:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400573:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  400576:	81 e9 c3 3a e7 76    	sub    $0x76e73ac3,%ecx
  40057c:	01 c1                	add    %eax,%ecx
  40057e:	81 c1 c3 3a e7 76    	add    $0x76e73ac3,%ecx
  400584:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  400587:	31 c0                	xor    %eax,%eax
  400589:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40058c:	83 e8 01             	sub    $0x1,%eax
  40058f:	29 c1                	sub    %eax,%ecx
  400591:	89 4d ec             	mov    %ecx,-0x14(%rbp)
  400594:	e9 cd ff ff ff       	jmpq   400566 <main+0x66>
  400599:	48 bf 44 06 40 00 00 	movabs $0x400644,%rdi
  4005a0:	00 00 00 
  4005a3:	8b 75 e8             	mov    -0x18(%rbp),%esi
  4005a6:	b0 00                	mov    $0x0,%al
  4005a8:	e8 53 fe ff ff       	callq  400400 <printf@plt>
  4005ad:	31 f6                	xor    %esi,%esi
  4005af:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  4005b2:	89 f0                	mov    %esi,%eax
