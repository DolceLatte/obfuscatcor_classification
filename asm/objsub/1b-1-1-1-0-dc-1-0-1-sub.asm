...
./sub//1b-1-1-1-0-dc-1-0-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400527:	48 bf 44 06 40 00 00 	movabs $0x400644,%rdi
  40052e:	00 00 00 
  ...
  400542:	e9 6a 00 00 00       	jmpq   4005b1 <main+0xb1>
  400547:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
  40054e:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400551:	48 8b 4d f0          	mov    -0x10(%rbp),%rcx
  400555:	48 8b 49 08          	mov    0x8(%rcx),%rcx
  400559:	0f be 11             	movsbl (%rcx),%edx
  40055c:	39 d0                	cmp    %edx,%eax
  40055e:	0f 8d 2f 00 00 00    	jge    400593 <main+0x93>
  ...
  40057e:	2d ad 0b a0 93       	sub    $0x93a00bad,%eax
  400583:	83 c0 01             	add    $0x1,%eax
  400586:	05 ad 0b a0 93       	add    $0x93a00bad,%eax
  40058b:	89 45 ec             	mov    %eax,-0x14(%rbp)
  40058e:	e9 bb ff ff ff       	jmpq   40054e <main+0x4e>
