...
./sub//1b-1-2-2-1-eq127-0-0-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400527:	0f 8e 3f 00 00 00    	jle    40056c <main+0x6c>
  40052d:	0f b6 45 ef          	movzbl -0x11(%rbp),%eax
  400531:	83 f8 7f             	cmp    $0x7f,%eax
  400534:	0f 85 19 00 00 00    	jne    400553 <main+0x53>
  40053a:	48 bf 14 06 40 00 00 	movabs $0x400614,%rdi
  400541:	00 00 00 
  400544:	b0 00                	mov    $0x0,%al
  400546:	e8 b5 fe ff ff       	callq  400400 <printf@plt>
  40054b:	89 45 e8             	mov    %eax,-0x18(%rbp)
  40054e:	e9 14 00 00 00       	jmpq   400567 <main+0x67>
  400553:	48 bf 19 06 40 00 00 	movabs $0x400619,%rdi
  40055a:	00 00 00 
  40055d:	b0 00                	mov    $0x0,%al
  40055f:	e8 9c fe ff ff       	callq  400400 <printf@plt>
  400564:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400567:	e9 14 00 00 00       	jmpq   400580 <main+0x80>
  40056c:	48 bf 1f 06 40 00 00 	movabs $0x40061f,%rdi
  400573:	00 00 00 
  ...
  400582:	48 83 c4 20          	add    $0x20,%rsp
  400586:	5d                   	pop    %rbp
  400587:	c3                   	retq   
