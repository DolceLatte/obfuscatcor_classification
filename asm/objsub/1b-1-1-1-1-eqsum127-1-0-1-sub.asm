...
./sub//1b-1-1-1-1-eqsum127-1-0-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400534:	0f 8d 29 00 00 00    	jge    400563 <main+0x63>
  40053a:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40053d:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  400540:	81 e9 cb bd 34 7a    	sub    $0x7a34bdcb,%ecx
  400546:	01 c1                	add    %eax,%ecx
  400548:	81 c1 cb bd 34 7a    	add    $0x7a34bdcb,%ecx
  40054e:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  400551:	31 c0                	xor    %eax,%eax
  400553:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  400556:	83 e8 01             	sub    $0x1,%eax
  400559:	29 c1                	sub    %eax,%ecx
  40055b:	89 4d ec             	mov    %ecx,-0x14(%rbp)
  40055e:	e9 c1 ff ff ff       	jmpq   400524 <main+0x24>
  400563:	81 7d e8 c0 1f 00 00 	cmpl   $0x1fc0,-0x18(%rbp)
  40056a:	0f 85 1c 00 00 00    	jne    40058c <main+0x8c>
  400570:	48 bf 34 06 40 00 00 	movabs $0x400634,%rdi
  400577:	00 00 00 
  ...
  400587:	e9 17 00 00 00       	jmpq   4005a3 <main+0xa3>
  40058c:	48 bf 34 06 40 00 00 	movabs $0x400634,%rdi
  400593:	00 00 00 
  400596:	8b 75 e8             	mov    -0x18(%rbp),%esi
  400599:	b0 00                	mov    $0x0,%al
  40059b:	e8 60 fe ff ff       	callq  400400 <printf@plt>
  4005a0:	89 45 e0             	mov    %eax,-0x20(%rbp)
