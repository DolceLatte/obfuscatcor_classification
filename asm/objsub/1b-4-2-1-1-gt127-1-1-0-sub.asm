...
./sub//1b-4-2-1-1-gt127-1-1-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	0f 8d 5a 00 00 00    	jge    40058a <main+0x8a>
  ...
  400542:	0f 8e 13 00 00 00    	jle    40055b <main+0x5b>
  400548:	8b 45 e8             	mov    -0x18(%rbp),%eax
  40054b:	2d 70 ac 44 73       	sub    $0x7344ac70,%eax
  400550:	83 c0 01             	add    $0x1,%eax
  400553:	05 70 ac 44 73       	add    $0x7344ac70,%eax
  400558:	89 45 e8             	mov    %eax,-0x18(%rbp)
  40055b:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40055e:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  400561:	81 c1 47 20 99 8c    	add    $0x8c992047,%ecx
  400567:	01 c1                	add    %eax,%ecx
  400569:	81 e9 47 20 99 8c    	sub    $0x8c992047,%ecx
  40056f:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  400572:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400575:	2d f9 af 77 42       	sub    $0x4277aff9,%eax
  40057a:	83 c0 01             	add    $0x1,%eax
  40057d:	05 f9 af 77 42       	add    $0x4277aff9,%eax
  400582:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400585:	e9 9a ff ff ff       	jmpq   400524 <main+0x24>
  40058a:	48 bf 34 06 40 00 00 	movabs $0x400634,%rdi
  400591:	00 00 00 
  400594:	8b 75 e8             	mov    -0x18(%rbp),%esi
  400597:	b0 00                	mov    $0x0,%al
  400599:	e8 62 fe ff ff       	callq  400400 <printf@plt>
  40059e:	31 f6                	xor    %esi,%esi
  4005a0:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  4005a3:	89 f0                	mov    %esi,%eax
  4005a5:	48 83 c4 20          	add    $0x20,%rsp
  4005a9:	5d                   	pop    %rbp
  4005aa:	c3                   	retq   
