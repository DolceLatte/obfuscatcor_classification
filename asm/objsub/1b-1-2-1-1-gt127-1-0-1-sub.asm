...
./sub//1b-1-2-1-1-gt127-1-0-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400548:	0f 8e 1c 00 00 00    	jle    40056a <main+0x6a>
  40054e:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400551:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  400554:	81 c1 59 b2 84 8d    	add    $0x8d84b259,%ecx
  40055a:	01 c1                	add    %eax,%ecx
  40055c:	81 e9 59 b2 84 8d    	sub    $0x8d84b259,%ecx
  400562:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  400565:	e9 0a 00 00 00       	jmpq   400574 <main+0x74>
  40056a:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40056d:	0f af 45 e8          	imul   -0x18(%rbp),%eax
  400571:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400574:	e9 00 00 00 00       	jmpq   400579 <main+0x79>
  400579:	31 c0                	xor    %eax,%eax
  40057b:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40057e:	83 e8 01             	sub    $0x1,%eax
  400581:	29 c1                	sub    %eax,%ecx
  400583:	89 4d ec             	mov    %ecx,-0x14(%rbp)
