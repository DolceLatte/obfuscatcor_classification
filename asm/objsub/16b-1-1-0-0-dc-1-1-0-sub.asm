...
./sub//16b-1-1-0-0-dc-1-1-0-sub.o:     file format elf64-x86-64
...
0000000000400410 <_start>:
  ...
  40041d:	50                   	push   %rax
  40041e:	54                   	push   %rsp
  40041f:	49 c7 c0 00 06 40 00 	mov    $0x400600,%r8
  400426:	48 c7 c1 90 05 40 00 	mov    $0x400590,%rcx
...
0000000000400500 <main>:
  ...
  400538:	0f 84 2c 00 00 00    	je     40056a <main+0x6a>
  40053e:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
  400542:	0f be 08             	movsbl (%rax),%ecx
  400545:	8b 55 e4             	mov    -0x1c(%rbp),%edx
  400548:	81 c2 75 74 83 85    	add    $0x85837475,%edx
  40054e:	01 ca                	add    %ecx,%edx
  400550:	81 ea 75 74 83 85    	sub    $0x85837475,%edx
  400556:	89 55 e4             	mov    %edx,-0x1c(%rbp)
  400559:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
  40055d:	48 83 c0 01          	add    $0x1,%rax
  400561:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
  400565:	e9 c7 ff ff ff       	jmpq   400531 <main+0x31>
  40056a:	48 bf 14 06 40 00 00 	movabs $0x400614,%rdi
  400571:	00 00 00 
  400574:	8b 75 e4             	mov    -0x1c(%rbp),%esi
  400577:	b0 00                	mov    $0x0,%al
  400579:	e8 82 fe ff ff       	callq  400400 <printf@plt>
  40057e:	31 f6                	xor    %esi,%esi
  400580:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  400583:	89 f0                	mov    %esi,%eax
  400585:	48 83 c4 40          	add    $0x40,%rsp
  400589:	5d                   	pop    %rbp
  40058a:	c3                   	retq   
...
0000000000400590 <__libc_csu_init>:
  ...
  4005bc:	e8 0f fe ff ff       	callq  4003d0 <_init>
