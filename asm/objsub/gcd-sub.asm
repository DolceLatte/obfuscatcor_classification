...
./sub//gcd-sub.o:     file format elf64-x86-64
...
0000000000400590 <main>:
  ...
  4005b7:	e9 c3 00 00 00       	jmpq   40067f <main+0xef>
  ...
  4005ea:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%rbp)
  4005f1:	b0 01                	mov    $0x1,%al
  4005f3:	8b 4d e4             	mov    -0x1c(%rbp),%ecx
  4005f6:	3b 4d ec             	cmp    -0x14(%rbp),%ecx
  4005f9:	88 45 d7             	mov    %al,-0x29(%rbp)
  4005fc:	0f 8e 0c 00 00 00    	jle    40060e <main+0x7e>
  400602:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  400605:	3b 45 e8             	cmp    -0x18(%rbp),%eax
  400608:	0f 9e c1             	setle  %cl
  40060b:	88 4d d7             	mov    %cl,-0x29(%rbp)
  40060e:	8a 45 d7             	mov    -0x29(%rbp),%al
  400611:	a8 01                	test   $0x1,%al
  400613:	0f 85 05 00 00 00    	jne    40061e <main+0x8e>
  400619:	e9 3d 00 00 00       	jmpq   40065b <main+0xcb>
  40061e:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400621:	99                   	cltd   
  400622:	f7 7d e4             	idivl  -0x1c(%rbp)
  400625:	83 fa 00             	cmp    $0x0,%edx
  400628:	0f 85 16 00 00 00    	jne    400644 <main+0xb4>
  40062e:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400631:	99                   	cltd   
  400632:	f7 7d e4             	idivl  -0x1c(%rbp)
  400635:	83 fa 00             	cmp    $0x0,%edx
  400638:	0f 85 06 00 00 00    	jne    400644 <main+0xb4>
  40063e:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  400641:	89 45 e0             	mov    %eax,-0x20(%rbp)
  400644:	e9 00 00 00 00       	jmpq   400649 <main+0xb9>
  400649:	31 c0                	xor    %eax,%eax
  40064b:	8b 4d e4             	mov    -0x1c(%rbp),%ecx
  40064e:	83 e8 01             	sub    $0x1,%eax
  400651:	29 c1                	sub    %eax,%ecx
  400653:	89 4d e4             	mov    %ecx,-0x1c(%rbp)
  400656:	e9 96 ff ff ff       	jmpq   4005f1 <main+0x61>
  40065b:	48 bf 14 07 40 00 00 	movabs $0x400714,%rdi
  400662:	00 00 00 
  400665:	8b 75 ec             	mov    -0x14(%rbp),%esi
  400668:	8b 55 e8             	mov    -0x18(%rbp),%edx
  40066b:	8b 4d e0             	mov    -0x20(%rbp),%ecx
  40066e:	b0 00                	mov    $0x0,%al
  400670:	e8 fb fd ff ff       	callq  400470 <printf@plt>
  400675:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  40067c:	89 45 d0             	mov    %eax,-0x30(%rbp)
  40067f:	8b 45 fc             	mov    -0x4(%rbp),%eax
  400682:	48 83 c4 30          	add    $0x30,%rsp
  400686:	5d                   	pop    %rbp
  400687:	c3                   	retq   
