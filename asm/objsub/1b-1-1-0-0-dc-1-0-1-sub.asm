...
./sub//1b-1-1-0-0-dc-1-0-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400534:	0f 8d 27 00 00 00    	jge    400561 <main+0x61>
  40053a:	31 c0                	xor    %eax,%eax
  40053c:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40053f:	8b 55 e8             	mov    -0x18(%rbp),%edx
  400542:	29 c8                	sub    %ecx,%eax
  400544:	29 c2                	sub    %eax,%edx
  400546:	89 55 e8             	mov    %edx,-0x18(%rbp)
  400549:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40054c:	2d a6 a4 f0 78       	sub    $0x78f0a4a6,%eax
  400551:	83 c0 01             	add    $0x1,%eax
  400554:	05 a6 a4 f0 78       	add    $0x78f0a4a6,%eax
  400559:	89 45 ec             	mov    %eax,-0x14(%rbp)
  40055c:	e9 c3 ff ff ff       	jmpq   400524 <main+0x24>
  400561:	48 bf 14 06 40 00 00 	movabs $0x400614,%rdi
  400568:	00 00 00 
  40056b:	8b 75 e8             	mov    -0x18(%rbp),%esi
  40056e:	b0 00                	mov    $0x0,%al
