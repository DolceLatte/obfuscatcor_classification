...
./sub//1b-4-1-0-0-dc-1-1-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	0f 8d 27 00 00 00    	jge    400557 <main+0x57>
  400530:	31 c0                	xor    %eax,%eax
  400532:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  400535:	8b 55 e8             	mov    -0x18(%rbp),%edx
  400538:	29 c8                	sub    %ecx,%eax
  40053a:	29 c2                	sub    %eax,%edx
  40053c:	89 55 e8             	mov    %edx,-0x18(%rbp)
  40053f:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400542:	05 7a 2e bc 45       	add    $0x45bc2e7a,%eax
  400547:	83 c0 01             	add    $0x1,%eax
  40054a:	2d 7a 2e bc 45       	sub    $0x45bc2e7a,%eax
  40054f:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400552:	e9 cd ff ff ff       	jmpq   400524 <main+0x24>
  400557:	48 bf 04 06 40 00 00 	movabs $0x400604,%rdi
  40055e:	00 00 00 
  400561:	8b 75 e8             	mov    -0x18(%rbp),%esi
  400564:	b0 00                	mov    $0x0,%al
  400566:	e8 95 fe ff ff       	callq  400400 <printf@plt>
  40056b:	31 f6                	xor    %esi,%esi
  40056d:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400570:	89 f0                	mov    %esi,%eax
  400572:	48 83 c4 20          	add    $0x20,%rsp
  400576:	5d                   	pop    %rbp
  400577:	c3                   	retq   
