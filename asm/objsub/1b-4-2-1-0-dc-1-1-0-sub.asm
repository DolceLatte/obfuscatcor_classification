...
./sub//1b-4-2-1-0-dc-1-1-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	0f 8d 40 00 00 00    	jge    400570 <main+0x70>
  400530:	83 7d e8 7f          	cmpl   $0x7f,-0x18(%rbp)
  400534:	0f 8d 0d 00 00 00    	jge    400547 <main+0x47>
  40053a:	31 c0                	xor    %eax,%eax
  40053c:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  40053f:	83 e8 40             	sub    $0x40,%eax
  400542:	29 c1                	sub    %eax,%ecx
  400544:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  400547:	31 c0                	xor    %eax,%eax
  400549:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40054c:	8b 55 e8             	mov    -0x18(%rbp),%edx
  40054f:	89 c6                	mov    %eax,%esi
  400551:	29 d6                	sub    %edx,%esi
  400553:	89 c2                	mov    %eax,%edx
  400555:	29 ca                	sub    %ecx,%edx
  400557:	01 d6                	add    %edx,%esi
  400559:	29 f0                	sub    %esi,%eax
  40055b:	89 45 e8             	mov    %eax,-0x18(%rbp)
  40055e:	31 c0                	xor    %eax,%eax
  400560:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  400563:	83 e8 01             	sub    $0x1,%eax
  400566:	29 c1                	sub    %eax,%ecx
  400568:	89 4d ec             	mov    %ecx,-0x14(%rbp)
  40056b:	e9 b4 ff ff ff       	jmpq   400524 <main+0x24>
  400570:	48 bf 24 06 40 00 00 	movabs $0x400624,%rdi
  400577:	00 00 00 
  40057a:	8b 75 e8             	mov    -0x18(%rbp),%esi
  40057d:	b0 00                	mov    $0x0,%al
  40057f:	e8 7c fe ff ff       	callq  400400 <printf@plt>
  400584:	31 f6                	xor    %esi,%esi
  400586:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400589:	89 f0                	mov    %esi,%eax
  40058b:	48 83 c4 20          	add    $0x20,%rsp
  40058f:	5d                   	pop    %rbp
  400590:	c3                   	retq   
