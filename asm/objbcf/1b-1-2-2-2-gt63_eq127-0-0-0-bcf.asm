...
./bcf//1b-1-2-2-2-gt63_eq127-0-0-0-bcf.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	0f 8e 53 00 00 00    	jle    400583 <main+0x83>
  ...
  40054b:	0f 85 19 00 00 00    	jne    40056a <main+0x6a>
  ...
  400565:	e9 14 00 00 00       	jmpq   40057e <main+0x7e>
  40056a:	48 bf c8 06 40 00 00 	movabs $0x4006c8,%rdi
  400571:	00 00 00 
  400574:	b0 00                	mov    $0x0,%al
  400576:	e8 85 fe ff ff       	callq  400400 <printf@plt>
  40057b:	89 45 e0             	mov    %eax,-0x20(%rbp)
  40057e:	e9 8b 00 00 00       	jmpq   40060e <main+0x10e>
  400583:	8b 04 25 34 10 60 00 	mov    0x601034,%eax
  40058a:	8b 0c 25 38 10 60 00 	mov    0x601038,%ecx
  ...
  4005b7:	e9 5a 00 00 00       	jmpq   400616 <main+0x116>
  4005bc:	48 bf d3 06 40 00 00 	movabs $0x4006d3,%rdi
  4005c3:	00 00 00 
  4005c6:	b0 00                	mov    $0x0,%al
  4005c8:	e8 33 fe ff ff       	callq  400400 <printf@plt>
  4005cd:	8b 0c 25 34 10 60 00 	mov    0x601034,%ecx
  4005d4:	8b 14 25 38 10 60 00 	mov    0x601038,%edx
  4005db:	89 ce                	mov    %ecx,%esi
  4005dd:	83 ee 01             	sub    $0x1,%esi
  4005e0:	0f af ce             	imul   %esi,%ecx
  4005e3:	83 e1 01             	and    $0x1,%ecx
  4005e6:	83 f9 00             	cmp    $0x0,%ecx
  4005e9:	41 0f 94 c0          	sete   %r8b
  4005ed:	83 fa 0a             	cmp    $0xa,%edx
  4005f0:	41 0f 9c c1          	setl   %r9b
  4005f4:	45 08 c8             	or     %r9b,%r8b
  4005f7:	41 f6 c0 01          	test   $0x1,%r8b
  4005fb:	89 45 dc             	mov    %eax,-0x24(%rbp)
  4005fe:	0f 85 05 00 00 00    	jne    400609 <main+0x109>
  400604:	e9 0d 00 00 00       	jmpq   400616 <main+0x116>
  400609:	e9 00 00 00 00       	jmpq   40060e <main+0x10e>
  40060e:	31 c0                	xor    %eax,%eax
  400610:	48 83 c4 30          	add    $0x30,%rsp
  400614:	5d                   	pop    %rbp
  400615:	c3                   	retq   
  400616:	48 bf d3 06 40 00 00 	movabs $0x4006d3,%rdi
  40061d:	00 00 00 
  400620:	b0 00                	mov    $0x0,%al
  400622:	e8 d9 fd ff ff       	callq  400400 <printf@plt>
  400627:	89 45 d8             	mov    %eax,-0x28(%rbp)
  40062a:	e9 8d ff ff ff       	jmpq   4005bc <main+0xbc>
  40062f:	90                   	nop
