...
./bcf//1b-1-1-1-1-eq127-0-0-0-bcf.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	0f 85 19 00 00 00    	jne    400549 <main+0x49>
  400530:	48 bf 84 06 40 00 00 	movabs $0x400684,%rdi
  400537:	00 00 00 
  40053a:	b0 00                	mov    $0x0,%al
  40053c:	e8 bf fe ff ff       	callq  400400 <printf@plt>
  400541:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400544:	e9 8b 00 00 00       	jmpq   4005d4 <main+0xd4>
  400549:	8b 04 25 34 10 60 00 	mov    0x601034,%eax
  400550:	8b 0c 25 38 10 60 00 	mov    0x601038,%ecx
  ...
  400565:	40 0f 94 c6          	sete   %sil
  400569:	83 f9 0a             	cmp    $0xa,%ecx
  40056c:	40 0f 9c c7          	setl   %dil
  400570:	40 08 fe             	or     %dil,%sil
  400573:	40 f6 c6 01          	test   $0x1,%sil
  400577:	0f 85 05 00 00 00    	jne    400582 <main+0x82>
  40057d:	e9 5a 00 00 00       	jmpq   4005dc <main+0xdc>
  400582:	48 bf 89 06 40 00 00 	movabs $0x400689,%rdi
  400589:	00 00 00 
  40058c:	b0 00                	mov    $0x0,%al
  40058e:	e8 6d fe ff ff       	callq  400400 <printf@plt>
  400593:	8b 0c 25 34 10 60 00 	mov    0x601034,%ecx
  40059a:	8b 14 25 38 10 60 00 	mov    0x601038,%edx
  4005a1:	89 ce                	mov    %ecx,%esi
  4005a3:	83 ee 01             	sub    $0x1,%esi
  4005a6:	0f af ce             	imul   %esi,%ecx
  4005a9:	83 e1 01             	and    $0x1,%ecx
  4005ac:	83 f9 00             	cmp    $0x0,%ecx
  4005af:	41 0f 94 c0          	sete   %r8b
  4005b3:	83 fa 0a             	cmp    $0xa,%edx
  4005b6:	41 0f 9c c1          	setl   %r9b
  4005ba:	45 08 c8             	or     %r9b,%r8b
  4005bd:	41 f6 c0 01          	test   $0x1,%r8b
  4005c1:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  4005c4:	0f 85 05 00 00 00    	jne    4005cf <main+0xcf>
  4005ca:	e9 0d 00 00 00       	jmpq   4005dc <main+0xdc>
  4005cf:	e9 00 00 00 00       	jmpq   4005d4 <main+0xd4>
  4005d4:	31 c0                	xor    %eax,%eax
  4005d6:	48 83 c4 20          	add    $0x20,%rsp
  4005da:	5d                   	pop    %rbp
  4005db:	c3                   	retq   
  4005dc:	48 bf 89 06 40 00 00 	movabs $0x400689,%rdi
  4005e3:	00 00 00 
  4005e6:	b0 00                	mov    $0x0,%al
  4005e8:	e8 13 fe ff ff       	callq  400400 <printf@plt>
  4005ed:	89 45 e0             	mov    %eax,-0x20(%rbp)
  4005f0:	e9 8d ff ff ff       	jmpq   400582 <main+0x82>
