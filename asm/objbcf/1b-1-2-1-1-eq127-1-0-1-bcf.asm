...
./bcf//1b-1-2-1-1-eq127-1-0-1-bcf.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400558:	e9 33 01 00 00       	jmpq   400690 <main+0x190>
  ...
  4005a9:	e9 e2 00 00 00       	jmpq   400690 <main+0x190>
  4005ae:	8a 45 e7             	mov    -0x19(%rbp),%al
  4005b1:	a8 01                	test   $0x1,%al
  4005b3:	0f 85 05 00 00 00    	jne    4005be <main+0xbe>
  4005b9:	e9 b1 00 00 00       	jmpq   40066f <main+0x16f>
  4005be:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  4005c2:	48 8b 40 08          	mov    0x8(%rax),%rax
  4005c6:	0f be 08             	movsbl (%rax),%ecx
  4005c9:	83 f9 7f             	cmp    $0x7f,%ecx
  4005cc:	0f 85 0e 00 00 00    	jne    4005e0 <main+0xe0>
  4005d2:	8b 45 ec             	mov    -0x14(%rbp),%eax
  4005d5:	03 45 e8             	add    -0x18(%rbp),%eax
  4005d8:	89 45 e8             	mov    %eax,-0x18(%rbp)
  4005db:	e9 0a 00 00 00       	jmpq   4005ea <main+0xea>
  4005e0:	8b 45 ec             	mov    -0x14(%rbp),%eax
  4005e3:	0f af 45 e8          	imul   -0x18(%rbp),%eax
  4005e7:	89 45 e8             	mov    %eax,-0x18(%rbp)
  4005ea:	8b 04 25 34 10 60 00 	mov    0x601034,%eax
  4005f1:	8b 0c 25 38 10 60 00 	mov    0x601038,%ecx
  4005f8:	89 c2                	mov    %eax,%edx
  4005fa:	83 ea 01             	sub    $0x1,%edx
  4005fd:	0f af c2             	imul   %edx,%eax
  400600:	83 e0 01             	and    $0x1,%eax
  400603:	83 f8 00             	cmp    $0x0,%eax
  400606:	40 0f 94 c6          	sete   %sil
  40060a:	83 f9 0a             	cmp    $0xa,%ecx
  40060d:	40 0f 9c c7          	setl   %dil
  400611:	40 08 fe             	or     %dil,%sil
  400614:	40 f6 c6 01          	test   $0x1,%sil
  400618:	0f 85 05 00 00 00    	jne    400623 <main+0x123>
  40061e:	e9 72 00 00 00       	jmpq   400695 <main+0x195>
  ...
  400657:	e9 39 00 00 00       	jmpq   400695 <main+0x195>
  40065c:	e9 00 00 00 00       	jmpq   400661 <main+0x161>
  400661:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400664:	83 c0 01             	add    $0x1,%eax
  400667:	89 45 ec             	mov    %eax,-0x14(%rbp)
  40066a:	e9 b5 fe ff ff       	jmpq   400524 <main+0x24>
  40066f:	48 bf 24 07 40 00 00 	movabs $0x400724,%rdi
  400676:	00 00 00 
  400679:	8b 75 e8             	mov    -0x18(%rbp),%esi
  40067c:	b0 00                	mov    $0x0,%al
  40067e:	e8 7d fd ff ff       	callq  400400 <printf@plt>
  400683:	31 f6                	xor    %esi,%esi
  400685:	89 45 e0             	mov    %eax,-0x20(%rbp)
  400688:	89 f0                	mov    %esi,%eax
  40068a:	48 83 c4 20          	add    $0x20,%rsp
  40068e:	5d                   	pop    %rbp
  40068f:	c3                   	retq   
  400690:	e9 c8 fe ff ff       	jmpq   40055d <main+0x5d>
  400695:	e9 89 ff ff ff       	jmpq   400623 <main+0x123>
