...
./fla//reverse-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40056e:	2d 4a aa 7d 0b       	sub    $0xb7daa4a,%eax
  400573:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  400576:	0f 84 eb 00 00 00    	je     400667 <main+0x167>
  40057c:	e9 00 00 00 00       	jmpq   400581 <main+0x81>
  400581:	8b 45 d4             	mov    -0x2c(%rbp),%eax
  400584:	2d c3 b2 58 48       	sub    $0x4858b2c3,%eax
  400589:	89 45 c0             	mov    %eax,-0x40(%rbp)
  40058c:	0f 84 9e 00 00 00    	je     400630 <main+0x130>
  400592:	e9 00 00 00 00       	jmpq   400597 <main+0x97>
  400597:	8b 45 d4             	mov    -0x2c(%rbp),%eax
  40059a:	2d ae 8d 6c 76       	sub    $0x766c8dae,%eax
  40059f:	89 45 bc             	mov    %eax,-0x44(%rbp)
  4005a2:	0f 84 20 00 00 00    	je     4005c8 <main+0xc8>
  4005a8:	e9 00 00 00 00       	jmpq   4005ad <main+0xad>
  4005ad:	8b 45 d4             	mov    -0x2c(%rbp),%eax
  4005b0:	2d 15 cf 58 78       	sub    $0x7858cf15,%eax
  4005b5:	89 45 b8             	mov    %eax,-0x48(%rbp)
  4005b8:	0f 84 59 00 00 00    	je     400617 <main+0x117>
  4005be:	e9 00 00 00 00       	jmpq   4005c3 <main+0xc3>
  4005c3:	e9 d2 00 00 00       	jmpq   40069a <main+0x19a>
  4005c8:	b8 f2 27 59 aa       	mov    $0xaa5927f2,%eax
  4005cd:	b9 af a5 0a e4       	mov    $0xe40aa5af,%ecx
  4005d2:	8b 55 fc             	mov    -0x4(%rbp),%edx
  4005d5:	83 fa 02             	cmp    $0x2,%edx
  4005d8:	0f 4c c1             	cmovl  %ecx,%eax
  4005db:	89 45 d8             	mov    %eax,-0x28(%rbp)
  4005de:	e9 b7 00 00 00       	jmpq   40069a <main+0x19a>
  4005e3:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%rbp)
  4005ea:	c7 45 d8 d7 1c ad da 	movl   $0xdaad1cd7,-0x28(%rbp)
  4005f1:	e9 a4 00 00 00       	jmpq   40069a <main+0x19a>
  4005f6:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
  4005fd:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  400601:	48 8b 40 08          	mov    0x8(%rax),%rax
  400605:	0f be 08             	movsbl (%rax),%ecx
  400608:	89 4d e4             	mov    %ecx,-0x1c(%rbp)
  40060b:	c7 45 d8 15 cf 58 78 	movl   $0x7858cf15,-0x28(%rbp)
  400612:	e9 83 00 00 00       	jmpq   40069a <main+0x19a>
  400617:	b8 4a aa 7d 0b       	mov    $0xb7daa4a,%eax
  40061c:	b9 c3 b2 58 48       	mov    $0x4858b2c3,%ecx
  400621:	83 7d e4 00          	cmpl   $0x0,-0x1c(%rbp)
  400625:	0f 45 c1             	cmovne %ecx,%eax
  400628:	89 45 d8             	mov    %eax,-0x28(%rbp)
  40062b:	e9 6a 00 00 00       	jmpq   40069a <main+0x19a>
  400630:	b8 0a 00 00 00       	mov    $0xa,%eax
  400635:	8b 4d e4             	mov    -0x1c(%rbp),%ecx
  400638:	89 45 b4             	mov    %eax,-0x4c(%rbp)
  40063b:	89 c8                	mov    %ecx,%eax
  40063d:	99                   	cltd   
  40063e:	8b 4d b4             	mov    -0x4c(%rbp),%ecx
  400641:	f7 f9                	idiv   %ecx
  400643:	89 55 e0             	mov    %edx,-0x20(%rbp)
  400646:	6b 55 dc 0a          	imul   $0xa,-0x24(%rbp),%edx
  40064a:	03 55 e0             	add    -0x20(%rbp),%edx
  40064d:	89 55 dc             	mov    %edx,-0x24(%rbp)
  400650:	8b 55 e4             	mov    -0x1c(%rbp),%edx
  400653:	89 d0                	mov    %edx,%eax
  400655:	99                   	cltd   
  400656:	f7 f9                	idiv   %ecx
  400658:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  40065b:	c7 45 d8 15 cf 58 78 	movl   $0x7858cf15,-0x28(%rbp)
  400662:	e9 33 00 00 00       	jmpq   40069a <main+0x19a>
  400667:	48 bf 24 07 40 00 00 	movabs $0x400724,%rdi
  40066e:	00 00 00 
  400671:	8b 75 dc             	mov    -0x24(%rbp),%esi
  400674:	b0 00                	mov    $0x0,%al
  400676:	e8 85 fd ff ff       	callq  400400 <printf@plt>
  40067b:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
  400682:	c7 45 d8 d7 1c ad da 	movl   $0xdaad1cd7,-0x28(%rbp)
  400689:	89 45 b0             	mov    %eax,-0x50(%rbp)
  40068c:	e9 09 00 00 00       	jmpq   40069a <main+0x19a>
  400691:	8b 45 f8             	mov    -0x8(%rbp),%eax
  400694:	48 83 c4 50          	add    $0x50,%rsp
  400698:	5d                   	pop    %rbp
  400699:	c3                   	retq   
  40069a:	e9 84 fe ff ff       	jmpq   400523 <main+0x23>
  40069f:	90                   	nop
