...
./fla//dekhash-fla.o:     file format elf64-x86-64
...
0000000000400540 <DEKHash>:
  ...
  40055f:	c7 45 e8 a4 34 aa 1d 	movl   $0x1daa34a4,-0x18(%rbp)
  400566:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400569:	89 c1                	mov    %eax,%ecx
  40056b:	81 e9 f5 29 93 e1    	sub    $0xe19329f5,%ecx
  400571:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400574:	89 4d e0             	mov    %ecx,-0x20(%rbp)
  400577:	0f 84 ae 00 00 00    	je     40062b <DEKHash+0xeb>
  40057d:	e9 00 00 00 00       	jmpq   400582 <DEKHash+0x42>
  400582:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  400585:	2d 4e dc 35 ff       	sub    $0xff35dc4e,%eax
  40058a:	89 45 dc             	mov    %eax,-0x24(%rbp)
  40058d:	0f 84 77 00 00 00    	je     40060a <DEKHash+0xca>
  400593:	e9 00 00 00 00       	jmpq   400598 <DEKHash+0x58>
  400598:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  40059b:	2d a4 34 aa 1d       	sub    $0x1daa34a4,%eax
  4005a0:	89 45 d8             	mov    %eax,-0x28(%rbp)
  4005a3:	0f 84 20 00 00 00    	je     4005c9 <DEKHash+0x89>
  4005a9:	e9 00 00 00 00       	jmpq   4005ae <DEKHash+0x6e>
  4005ae:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  4005b1:	2d 7d 49 66 73       	sub    $0x7366497d,%eax
  4005b6:	89 45 d4             	mov    %eax,-0x2c(%rbp)
  4005b9:	0f 84 25 00 00 00    	je     4005e4 <DEKHash+0xa4>
  4005bf:	e9 00 00 00 00       	jmpq   4005c4 <DEKHash+0x84>
  4005c4:	e9 67 00 00 00       	jmpq   400630 <DEKHash+0xf0>
  4005c9:	b8 f5 29 93 e1       	mov    $0xe19329f5,%eax
  4005ce:	b9 7d 49 66 73       	mov    $0x7366497d,%ecx
  4005d3:	8b 55 ec             	mov    -0x14(%rbp),%edx
  4005d6:	3b 55 f4             	cmp    -0xc(%rbp),%edx
  4005d9:	0f 42 c1             	cmovb  %ecx,%eax
  4005dc:	89 45 e8             	mov    %eax,-0x18(%rbp)
  4005df:	e9 4c 00 00 00       	jmpq   400630 <DEKHash+0xf0>
  4005e4:	8b 45 f0             	mov    -0x10(%rbp),%eax
  4005e7:	c1 e0 05             	shl    $0x5,%eax
  4005ea:	8b 4d f0             	mov    -0x10(%rbp),%ecx
  4005ed:	c1 e9 1b             	shr    $0x1b,%ecx
  4005f0:	31 c8                	xor    %ecx,%eax
  4005f2:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  4005f6:	0f be 0a             	movsbl (%rdx),%ecx
  4005f9:	31 c8                	xor    %ecx,%eax
  4005fb:	89 45 f0             	mov    %eax,-0x10(%rbp)
  4005fe:	c7 45 e8 4e dc 35 ff 	movl   $0xff35dc4e,-0x18(%rbp)
  400605:	e9 26 00 00 00       	jmpq   400630 <DEKHash+0xf0>
  40060a:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  40060e:	48 83 c0 01          	add    $0x1,%rax
  400612:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  400616:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  400619:	83 c1 01             	add    $0x1,%ecx
  40061c:	89 4d ec             	mov    %ecx,-0x14(%rbp)
  40061f:	c7 45 e8 a4 34 aa 1d 	movl   $0x1daa34a4,-0x18(%rbp)
  400626:	e9 05 00 00 00       	jmpq   400630 <DEKHash+0xf0>
  40062b:	8b 45 f0             	mov    -0x10(%rbp),%eax
  40062e:	5d                   	pop    %rbp
  40062f:	c3                   	retq   
  400630:	e9 31 ff ff ff       	jmpq   400566 <DEKHash+0x26>
...
0000000000400640 <main>:
  ...
  4006e0:	b8 91 bb 09 ad       	mov    $0xad09bb91,%eax
  4006e5:	b9 72 c9 5b c8       	mov    $0xc85bc972,%ecx
  4006ea:	8b 55 fc             	mov    -0x4(%rbp),%edx
  4006ed:	81 fa b7 63 43 de    	cmp    $0xde4363b7,%edx
  ...
  40070f:	c7 45 d8 91 bb 09 ad 	movl   $0xad09bb91,-0x28(%rbp)
