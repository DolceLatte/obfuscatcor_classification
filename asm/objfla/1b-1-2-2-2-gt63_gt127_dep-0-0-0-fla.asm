...
./fla//1b-1-2-2-2-gt63_gt127_dep-0-0-0-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400566:	2d d8 ac 29 de       	sub    $0xde29acd8,%eax
  ...
  40057c:	2d 9b 98 43 fd       	sub    $0xfd43989b,%eax
  ...
  4005d6:	b8 8f 07 b9 43       	mov    $0x43b9078f,%eax
  4005db:	b9 9b 98 43 fd       	mov    $0xfd43989b,%ecx
  ...
  400602:	b9 51 96 03 56       	mov    $0x56039651,%ecx
  400607:	ba d8 ac 29 de       	mov    $0xde29acd8,%edx
  ...
  40062c:	0f b6 45 e7          	movzbl -0x19(%rbp),%eax
  400630:	83 f8 7f             	cmp    $0x7f,%eax
  400633:	8b 45 b8             	mov    -0x48(%rbp),%eax
  400636:	0f 4f c8             	cmovg  %eax,%ecx
  ...
  400652:	c7 45 e0 11 7e 46 83 	movl   $0x83467e11,-0x20(%rbp)
  ...
  400672:	c7 45 e0 11 7e 46 83 	movl   $0x83467e11,-0x20(%rbp)
  400679:	89 45 b0             	mov    %eax,-0x50(%rbp)
  40067c:	e9 34 00 00 00       	jmpq   4006b5 <main+0x1b5>
  400681:	c7 45 e0 0d 6c ce 0c 	movl   $0xcce6c0d,-0x20(%rbp)
  ...
  40069e:	c7 45 e0 0d 6c ce 0c 	movl   $0xcce6c0d,-0x20(%rbp)
