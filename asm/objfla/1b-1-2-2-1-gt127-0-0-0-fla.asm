...
./fla//1b-1-2-2-1-gt127-0-0-0-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  4005d5:	b8 2f e4 bc 57       	mov    $0x57bce42f,%eax
  4005da:	b9 30 39 dd 6b       	mov    $0x6bdd3930,%ecx
  ...
  4005f0:	b8 26 27 1e 17       	mov    $0x171e2726,%eax
  4005f5:	b9 68 cb 86 2b       	mov    $0x2b86cb68,%ecx
  4005fa:	0f b6 55 e7          	movzbl -0x19(%rbp),%edx
  4005fe:	83 fa 7f             	cmp    $0x7f,%edx
  400601:	0f 4f c1             	cmovg  %ecx,%eax
  ...
  40061d:	c7 45 e0 08 88 6c 99 	movl   $0x996c8808,-0x20(%rbp)
  ...
  40063d:	c7 45 e0 08 88 6c 99 	movl   $0x996c8808,-0x20(%rbp)
  400644:	89 45 b8             	mov    %eax,-0x48(%rbp)
  400647:	e9 34 00 00 00       	jmpq   400680 <main+0x180>
  40064c:	c7 45 e0 d6 08 53 ca 	movl   $0xca5308d6,-0x20(%rbp)
  ...
  400669:	c7 45 e0 d6 08 53 ca 	movl   $0xca5308d6,-0x20(%rbp)
