...
./fla//djbhash-fla.o:     file format elf64-x86-64
...
0000000000400540 <DJBHash>:
  ...
  400560:	c7 45 e8 a4 43 ba d6 	movl   $0xd6ba43a4,-0x18(%rbp)
  400567:	8b 45 e8             	mov    -0x18(%rbp),%eax
  40056a:	89 c1                	mov    %eax,%ecx
  40056c:	81 e9 e7 1a be 88    	sub    $0x88be1ae7,%ecx
  400572:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400575:	89 4d e0             	mov    %ecx,-0x20(%rbp)
  400578:	0f 84 a9 00 00 00    	je     400627 <DJBHash+0xe7>
  40057e:	e9 00 00 00 00       	jmpq   400583 <DJBHash+0x43>
  400583:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  400586:	2d a4 43 ba d6       	sub    $0xd6ba43a4,%eax
  40058b:	89 45 dc             	mov    %eax,-0x24(%rbp)
  40058e:	0f 84 36 00 00 00    	je     4005ca <DJBHash+0x8a>
  400594:	e9 00 00 00 00       	jmpq   400599 <DJBHash+0x59>
  400599:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  40059c:	2d 7f c3 a2 00       	sub    $0xa2c37f,%eax
  4005a1:	89 45 d8             	mov    %eax,-0x28(%rbp)
  4005a4:	0f 84 5c 00 00 00    	je     400606 <DJBHash+0xc6>
  4005aa:	e9 00 00 00 00       	jmpq   4005af <DJBHash+0x6f>
  4005af:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  4005b2:	2d 5d 3f e6 07       	sub    $0x7e63f5d,%eax
  4005b7:	89 45 d4             	mov    %eax,-0x2c(%rbp)
  4005ba:	0f 84 25 00 00 00    	je     4005e5 <DJBHash+0xa5>
  4005c0:	e9 00 00 00 00       	jmpq   4005c5 <DJBHash+0x85>
  4005c5:	e9 62 00 00 00       	jmpq   40062c <DJBHash+0xec>
  4005ca:	b8 e7 1a be 88       	mov    $0x88be1ae7,%eax
  4005cf:	b9 5d 3f e6 07       	mov    $0x7e63f5d,%ecx
  ...
  4005e0:	e9 47 00 00 00       	jmpq   40062c <DJBHash+0xec>
  4005e5:	8b 45 f0             	mov    -0x10(%rbp),%eax
  4005e8:	c1 e0 05             	shl    $0x5,%eax
  4005eb:	03 45 f0             	add    -0x10(%rbp),%eax
  4005ee:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
  4005f2:	0f be 11             	movsbl (%rcx),%edx
  4005f5:	01 d0                	add    %edx,%eax
  4005f7:	89 45 f0             	mov    %eax,-0x10(%rbp)
  4005fa:	c7 45 e8 7f c3 a2 00 	movl   $0xa2c37f,-0x18(%rbp)
  400601:	e9 26 00 00 00       	jmpq   40062c <DJBHash+0xec>
  400606:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  40060a:	48 83 c0 01          	add    $0x1,%rax
  40060e:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  400612:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  400615:	83 c1 01             	add    $0x1,%ecx
  400618:	89 4d ec             	mov    %ecx,-0x14(%rbp)
  40061b:	c7 45 e8 a4 43 ba d6 	movl   $0xd6ba43a4,-0x18(%rbp)
  400622:	e9 05 00 00 00       	jmpq   40062c <DJBHash+0xec>
  400627:	8b 45 f0             	mov    -0x10(%rbp),%eax
  40062a:	5d                   	pop    %rbp
  40062b:	c3                   	retq   
  40062c:	e9 36 ff ff ff       	jmpq   400567 <DJBHash+0x27>
  400631:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
...
0000000000400640 <main>:
  ...
  4006b2:	2d d6 67 56 4b       	sub    $0x4b5667d6,%eax
  4006b7:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  4006ba:	0f 84 20 00 00 00    	je     4006e0 <main+0xa0>
  4006c0:	e9 00 00 00 00       	jmpq   4006c5 <main+0x85>
  4006c5:	8b 45 cc             	mov    -0x34(%rbp),%eax
  4006c8:	2d af 7a 5d 72       	sub    $0x725d7aaf,%eax
  4006cd:	89 45 c0             	mov    %eax,-0x40(%rbp)
  4006d0:	0f 84 48 00 00 00    	je     40071e <main+0xde>
  4006d6:	e9 00 00 00 00       	jmpq   4006db <main+0x9b>
  4006db:	e9 46 00 00 00       	jmpq   400726 <main+0xe6>
  4006e0:	b8 af 7a 5d 72       	mov    $0x725d7aaf,%eax
  4006e5:	b9 a4 ca 47 85       	mov    $0x8547caa4,%ecx
  4006ea:	8b 55 fc             	mov    -0x4(%rbp),%edx
  4006ed:	81 fa 35 49 a5 49    	cmp    $0x49a54935,%edx
  ...
  40070f:	c7 45 d8 af 7a 5d 72 	movl   $0x725d7aaf,-0x28(%rbp)
