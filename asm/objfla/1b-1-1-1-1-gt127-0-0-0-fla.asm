...
./fla//1b-1-1-1-1-gt127-0-0-0-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	c7 45 e0 e2 d8 7c 3b 	movl   $0x3b7cd8e2,-0x20(%rbp)
  400531:	8b 45 e0             	mov    -0x20(%rbp),%eax
  400534:	89 c1                	mov    %eax,%ecx
  400536:	81 e9 ef 56 6d 8d    	sub    $0x8d6d56ef,%ecx
  40053c:	89 45 dc             	mov    %eax,-0x24(%rbp)
  40053f:	89 4d d8             	mov    %ecx,-0x28(%rbp)
  400542:	0f 84 a7 00 00 00    	je     4005ef <main+0xef>
  400548:	e9 00 00 00 00       	jmpq   40054d <main+0x4d>
  40054d:	8b 45 dc             	mov    -0x24(%rbp),%eax
  400550:	2d 48 48 71 bc       	sub    $0xbc714848,%eax
  400555:	89 45 d4             	mov    %eax,-0x2c(%rbp)
  400558:	0f 84 71 00 00 00    	je     4005cf <main+0xcf>
  40055e:	e9 00 00 00 00       	jmpq   400563 <main+0x63>
  400563:	8b 45 dc             	mov    -0x24(%rbp),%eax
  400566:	2d b5 62 5f d1       	sub    $0xd15f62b5,%eax
  40056b:	89 45 d0             	mov    %eax,-0x30(%rbp)
  40056e:	0f 84 3b 00 00 00    	je     4005af <main+0xaf>
  400574:	e9 00 00 00 00       	jmpq   400579 <main+0x79>
  400579:	8b 45 dc             	mov    -0x24(%rbp),%eax
  40057c:	2d e2 d8 7c 3b       	sub    $0x3b7cd8e2,%eax
  400581:	89 45 cc             	mov    %eax,-0x34(%rbp)
  400584:	0f 84 0a 00 00 00    	je     400594 <main+0x94>
  40058a:	e9 00 00 00 00       	jmpq   40058f <main+0x8f>
  40058f:	e9 63 00 00 00       	jmpq   4005f7 <main+0xf7>
  400594:	b8 48 48 71 bc       	mov    $0xbc714848,%eax
  400599:	b9 b5 62 5f d1       	mov    $0xd15f62b5,%ecx
  40059e:	8b 55 fc             	mov    -0x4(%rbp),%edx
  4005a1:	83 fa 7f             	cmp    $0x7f,%edx
  4005a4:	0f 4f c1             	cmovg  %ecx,%eax
  4005a7:	89 45 e0             	mov    %eax,-0x20(%rbp)
  4005aa:	e9 48 00 00 00       	jmpq   4005f7 <main+0xf7>
  4005af:	48 bf 84 06 40 00 00 	movabs $0x400684,%rdi
  4005b6:	00 00 00 
  4005b9:	b0 00                	mov    $0x0,%al
  4005bb:	e8 40 fe ff ff       	callq  400400 <printf@plt>
  4005c0:	c7 45 e0 ef 56 6d 8d 	movl   $0x8d6d56ef,-0x20(%rbp)
  4005c7:	89 45 c8             	mov    %eax,-0x38(%rbp)
  4005ca:	e9 28 00 00 00       	jmpq   4005f7 <main+0xf7>
  4005cf:	48 bf 89 06 40 00 00 	movabs $0x400689,%rdi
  4005d6:	00 00 00 
  4005d9:	b0 00                	mov    $0x0,%al
  4005db:	e8 20 fe ff ff       	callq  400400 <printf@plt>
  4005e0:	c7 45 e0 ef 56 6d 8d 	movl   $0x8d6d56ef,-0x20(%rbp)
  4005e7:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  4005ea:	e9 08 00 00 00       	jmpq   4005f7 <main+0xf7>
  4005ef:	31 c0                	xor    %eax,%eax
  4005f1:	48 83 c4 40          	add    $0x40,%rsp
  4005f5:	5d                   	pop    %rbp
  4005f6:	c3                   	retq   
  4005f7:	e9 35 ff ff ff       	jmpq   400531 <main+0x31>
