...
./fla//1b-1-1-2-2-gt85_lt170-0-0-0-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400592:	2d 52 c2 40 54       	sub    $0x5440c252,%eax
  400597:	89 45 c8             	mov    %eax,-0x38(%rbp)
  40059a:	0f 84 91 00 00 00    	je     400631 <main+0x131>
  4005a0:	e9 00 00 00 00       	jmpq   4005a5 <main+0xa5>
  4005a5:	8b 45 dc             	mov    -0x24(%rbp),%eax
  4005a8:	2d ba 05 0d 5d       	sub    $0x5d0d05ba,%eax
  4005ad:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  4005b0:	0f 84 da 00 00 00    	je     400690 <main+0x190>
  4005b6:	e9 00 00 00 00       	jmpq   4005bb <main+0xbb>
  4005bb:	8b 45 dc             	mov    -0x24(%rbp),%eax
  4005be:	2d 78 dd bc 60       	sub    $0x60bcdd78,%eax
  4005c3:	89 45 c0             	mov    %eax,-0x40(%rbp)
  4005c6:	0f 84 84 00 00 00    	je     400650 <main+0x150>
  4005cc:	e9 00 00 00 00       	jmpq   4005d1 <main+0xd1>
  4005d1:	e9 c2 00 00 00       	jmpq   400698 <main+0x198>
  4005d6:	b8 45 03 6b bd       	mov    $0xbd6b0345,%eax
  4005db:	b9 5c 25 9f f7       	mov    $0xf79f255c,%ecx
  4005e0:	8b 55 fc             	mov    -0x4(%rbp),%edx
  4005e3:	83 fa 55             	cmp    $0x55,%edx
  4005e6:	0f 4f c1             	cmovg  %ecx,%eax
  4005e9:	89 45 e0             	mov    %eax,-0x20(%rbp)
  4005ec:	e9 a7 00 00 00       	jmpq   400698 <main+0x198>
  4005f1:	48 bf 24 07 40 00 00 	movabs $0x400724,%rdi
  4005f8:	00 00 00 
  4005fb:	b0 00                	mov    $0x0,%al
  4005fd:	e8 fe fd ff ff       	callq  400400 <printf@plt>
  400602:	c7 45 e0 52 c2 40 54 	movl   $0x5440c252,-0x20(%rbp)
  400609:	89 45 bc             	mov    %eax,-0x44(%rbp)
  40060c:	e9 87 00 00 00       	jmpq   400698 <main+0x198>
  400611:	48 bf 2e 07 40 00 00 	movabs $0x40072e,%rdi
  400618:	00 00 00 
  40061b:	b0 00                	mov    $0x0,%al
  40061d:	e8 de fd ff ff       	callq  400400 <printf@plt>
  400622:	c7 45 e0 52 c2 40 54 	movl   $0x5440c252,-0x20(%rbp)
  400629:	89 45 b8             	mov    %eax,-0x48(%rbp)
  40062c:	e9 67 00 00 00       	jmpq   400698 <main+0x198>
  400631:	b8 9e ce 5e d6       	mov    $0xd65ece9e,%eax
  400636:	b9 78 dd bc 60       	mov    $0x60bcdd78,%ecx
  40063b:	0f b6 55 e7          	movzbl -0x19(%rbp),%edx
  40063f:	81 fa aa 00 00 00    	cmp    $0xaa,%edx
  400645:	0f 4c c1             	cmovl  %ecx,%eax
  400648:	89 45 e0             	mov    %eax,-0x20(%rbp)
  40064b:	e9 48 00 00 00       	jmpq   400698 <main+0x198>
  400650:	48 bf 39 07 40 00 00 	movabs $0x400739,%rdi
  400657:	00 00 00 
  40065a:	b0 00                	mov    $0x0,%al
  40065c:	e8 9f fd ff ff       	callq  400400 <printf@plt>
  400661:	c7 45 e0 ba 05 0d 5d 	movl   $0x5d0d05ba,-0x20(%rbp)
  400668:	89 45 b4             	mov    %eax,-0x4c(%rbp)
  40066b:	e9 28 00 00 00       	jmpq   400698 <main+0x198>
  400670:	48 bf 43 07 40 00 00 	movabs $0x400743,%rdi
  400677:	00 00 00 
  40067a:	b0 00                	mov    $0x0,%al
  40067c:	e8 7f fd ff ff       	callq  400400 <printf@plt>
  400681:	c7 45 e0 ba 05 0d 5d 	movl   $0x5d0d05ba,-0x20(%rbp)
  400688:	89 45 b0             	mov    %eax,-0x50(%rbp)
  40068b:	e9 08 00 00 00       	jmpq   400698 <main+0x198>
  400690:	31 c0                	xor    %eax,%eax
  400692:	48 83 c4 50          	add    $0x50,%rsp
  400696:	5d                   	pop    %rbp
  400697:	c3                   	retq   
  400698:	e9 94 fe ff ff       	jmpq   400531 <main+0x31>
