...
./fla//1b-1-1-0-0-dc-2-0-2-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400524:	c7 45 e4 46 ac 6a 0b 	movl   $0xb6aac46,-0x1c(%rbp)
  40052b:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  40052e:	89 c1                	mov    %eax,%ecx
  400530:	81 e9 df 83 0a 8d    	sub    $0x8d0a83df,%ecx
  400536:	89 45 e0             	mov    %eax,-0x20(%rbp)
  400539:	89 4d dc             	mov    %ecx,-0x24(%rbp)
  40053c:	0f 84 de 00 00 00    	je     400620 <main+0x120>
  400542:	e9 00 00 00 00       	jmpq   400547 <main+0x47>
  400547:	8b 45 e0             	mov    -0x20(%rbp),%eax
  40054a:	2d 32 ce e4 91       	sub    $0x91e4ce32,%eax
  40054f:	89 45 d8             	mov    %eax,-0x28(%rbp)
  400552:	0f 84 2a 01 00 00    	je     400682 <main+0x182>
  400558:	e9 00 00 00 00       	jmpq   40055d <main+0x5d>
  40055d:	8b 45 e0             	mov    -0x20(%rbp),%eax
  400560:	2d cd 1e 9d cb       	sub    $0xcb9d1ecd,%eax
  400565:	89 45 d4             	mov    %eax,-0x2c(%rbp)
  400568:	0f 84 da 00 00 00    	je     400648 <main+0x148>
  40056e:	e9 00 00 00 00       	jmpq   400573 <main+0x73>
  400573:	8b 45 e0             	mov    -0x20(%rbp),%eax
  400576:	2d 1f 79 b1 d0       	sub    $0xd0b1791f,%eax
  40057b:	89 45 d0             	mov    %eax,-0x30(%rbp)
  40057e:	0f 84 b1 00 00 00    	je     400635 <main+0x135>
  400584:	e9 00 00 00 00       	jmpq   400589 <main+0x89>
  400589:	8b 45 e0             	mov    -0x20(%rbp),%eax
  40058c:	2d e8 c9 b0 05       	sub    $0x5b0c9e8,%eax
  400591:	89 45 cc             	mov    %eax,-0x34(%rbp)
  400594:	0f 84 d3 00 00 00    	je     40066d <main+0x16d>
  40059a:	e9 00 00 00 00       	jmpq   40059f <main+0x9f>
  40059f:	8b 45 e0             	mov    -0x20(%rbp),%eax
  4005a2:	2d 46 ac 6a 0b       	sub    $0xb6aac46,%eax
  4005a7:	89 45 c8             	mov    %eax,-0x38(%rbp)
  4005aa:	0f 84 36 00 00 00    	je     4005e6 <main+0xe6>
  4005b0:	e9 00 00 00 00       	jmpq   4005b5 <main+0xb5>
  4005b5:	8b 45 e0             	mov    -0x20(%rbp),%eax
  4005b8:	2d be 07 c4 17       	sub    $0x17c407be,%eax
  4005bd:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  4005c0:	0f 84 45 00 00 00    	je     40060b <main+0x10b>
  4005c6:	e9 00 00 00 00       	jmpq   4005cb <main+0xcb>
  4005cb:	8b 45 e0             	mov    -0x20(%rbp),%eax
  4005ce:	2d d9 4b 23 31       	sub    $0x31234bd9,%eax
  4005d3:	89 45 c0             	mov    %eax,-0x40(%rbp)
  4005d6:	0f 84 bb 00 00 00    	je     400697 <main+0x197>
  4005dc:	e9 00 00 00 00       	jmpq   4005e1 <main+0xe1>
  4005e1:	e9 d2 00 00 00       	jmpq   4006b8 <main+0x1b8>
  4005e6:	b8 1f 79 b1 d0       	mov    $0xd0b1791f,%eax
  4005eb:	b9 be 07 c4 17       	mov    $0x17c407be,%ecx
  4005f0:	8b 55 ec             	mov    -0x14(%rbp),%edx
  4005f3:	48 8b 75 f0          	mov    -0x10(%rbp),%rsi
  4005f7:	48 8b 76 08          	mov    0x8(%rsi),%rsi
  4005fb:	0f be 3e             	movsbl (%rsi),%edi
  4005fe:	39 fa                	cmp    %edi,%edx
  400600:	0f 4c c1             	cmovl  %ecx,%eax
  400603:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400606:	e9 ad 00 00 00       	jmpq   4006b8 <main+0x1b8>
  40060b:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40060e:	03 45 e8             	add    -0x18(%rbp),%eax
  400611:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400614:	c7 45 e4 df 83 0a 8d 	movl   $0x8d0a83df,-0x1c(%rbp)
  40061b:	e9 98 00 00 00       	jmpq   4006b8 <main+0x1b8>
  400620:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400623:	83 c0 01             	add    $0x1,%eax
  400626:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400629:	c7 45 e4 46 ac 6a 0b 	movl   $0xb6aac46,-0x1c(%rbp)
  400630:	e9 83 00 00 00       	jmpq   4006b8 <main+0x1b8>
  400635:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
  40063c:	c7 45 e4 cd 1e 9d cb 	movl   $0xcb9d1ecd,-0x1c(%rbp)
  400643:	e9 70 00 00 00       	jmpq   4006b8 <main+0x1b8>
  400648:	b8 d9 4b 23 31       	mov    $0x31234bd9,%eax
  40064d:	b9 e8 c9 b0 05       	mov    $0x5b0c9e8,%ecx
  400652:	8b 55 ec             	mov    -0x14(%rbp),%edx
  400655:	48 8b 75 f0          	mov    -0x10(%rbp),%rsi
  400659:	48 8b 76 08          	mov    0x8(%rsi),%rsi
  40065d:	0f be 3e             	movsbl (%rsi),%edi
  400660:	39 fa                	cmp    %edi,%edx
  400662:	0f 4c c1             	cmovl  %ecx,%eax
  400665:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400668:	e9 4b 00 00 00       	jmpq   4006b8 <main+0x1b8>
  40066d:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400670:	03 45 e8             	add    -0x18(%rbp),%eax
  400673:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400676:	c7 45 e4 32 ce e4 91 	movl   $0x91e4ce32,-0x1c(%rbp)
  40067d:	e9 36 00 00 00       	jmpq   4006b8 <main+0x1b8>
  400682:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400685:	83 c0 01             	add    $0x1,%eax
  400688:	89 45 ec             	mov    %eax,-0x14(%rbp)
  40068b:	c7 45 e4 cd 1e 9d cb 	movl   $0xcb9d1ecd,-0x1c(%rbp)
  400692:	e9 21 00 00 00       	jmpq   4006b8 <main+0x1b8>
  400697:	48 bf 44 07 40 00 00 	movabs $0x400744,%rdi
  40069e:	00 00 00 
  4006a1:	8b 75 e8             	mov    -0x18(%rbp),%esi
  4006a4:	b0 00                	mov    $0x0,%al
  4006a6:	e8 55 fd ff ff       	callq  400400 <printf@plt>
  4006ab:	31 f6                	xor    %esi,%esi
  4006ad:	89 45 bc             	mov    %eax,-0x44(%rbp)
  4006b0:	89 f0                	mov    %esi,%eax
  4006b2:	48 83 c4 50          	add    $0x50,%rsp
  4006b6:	5d                   	pop    %rbp
  4006b7:	c3                   	retq   
  4006b8:	e9 6e fe ff ff       	jmpq   40052b <main+0x2b>
