...
./fla//jshash-fla.o:     file format elf64-x86-64
...
0000000000400540 <JSHash>:
  ...
  400560:	c7 45 e8 30 92 17 e4 	movl   $0xe4179230,-0x18(%rbp)
  400567:	8b 45 e8             	mov    -0x18(%rbp),%eax
  40056a:	89 c1                	mov    %eax,%ecx
  40056c:	81 e9 42 c9 21 b4    	sub    $0xb421c942,%ecx
  400572:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400575:	89 4d e0             	mov    %ecx,-0x20(%rbp)
  400578:	0f 84 90 00 00 00    	je     40060e <JSHash+0xce>
  40057e:	e9 00 00 00 00       	jmpq   400583 <JSHash+0x43>
  400583:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  400586:	2d 30 92 17 e4       	sub    $0xe4179230,%eax
  40058b:	89 45 dc             	mov    %eax,-0x24(%rbp)
  40058e:	0f 84 36 00 00 00    	je     4005ca <JSHash+0x8a>
  400594:	e9 00 00 00 00       	jmpq   400599 <JSHash+0x59>
  400599:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  40059c:	2d c7 be 44 f7       	sub    $0xf744bec7,%eax
  4005a1:	89 45 d8             	mov    %eax,-0x28(%rbp)
  4005a4:	0f 84 3b 00 00 00    	je     4005e5 <JSHash+0xa5>
  4005aa:	e9 00 00 00 00       	jmpq   4005af <JSHash+0x6f>
  4005af:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  4005b2:	2d 52 75 31 63       	sub    $0x63317552,%eax
  4005b7:	89 45 d4             	mov    %eax,-0x2c(%rbp)
  4005ba:	0f 84 6f 00 00 00    	je     40062f <JSHash+0xef>
  4005c0:	e9 00 00 00 00       	jmpq   4005c5 <JSHash+0x85>
  4005c5:	e9 6a 00 00 00       	jmpq   400634 <JSHash+0xf4>
  4005ca:	b8 52 75 31 63       	mov    $0x63317552,%eax
  4005cf:	b9 c7 be 44 f7       	mov    $0xf744bec7,%ecx
  ...
  4005e0:	e9 4f 00 00 00       	jmpq   400634 <JSHash+0xf4>
  ...
  4005f7:	c1 ea 02             	shr    $0x2,%edx
  4005fa:	01 d0                	add    %edx,%eax
  4005fc:	33 45 f0             	xor    -0x10(%rbp),%eax
  4005ff:	89 45 f0             	mov    %eax,-0x10(%rbp)
  400602:	c7 45 e8 42 c9 21 b4 	movl   $0xb421c942,-0x18(%rbp)
  400609:	e9 26 00 00 00       	jmpq   400634 <JSHash+0xf4>
  ...
  400623:	c7 45 e8 30 92 17 e4 	movl   $0xe4179230,-0x18(%rbp)
  40062a:	e9 05 00 00 00       	jmpq   400634 <JSHash+0xf4>
  40062f:	8b 45 f0             	mov    -0x10(%rbp),%eax
  400632:	5d                   	pop    %rbp
  400633:	c3                   	retq   
  400634:	e9 2e ff ff ff       	jmpq   400567 <JSHash+0x27>
...
0000000000400640 <main>:
  ...
  4006c8:	2d 90 ce 40 76       	sub    $0x7640ce90,%eax
  ...
  4006e0:	b8 59 21 5f 46       	mov    $0x465f2159,%eax
  4006e5:	b9 90 ce 40 76       	mov    $0x7640ce90,%ecx
  4006ea:	8b 55 fc             	mov    -0x4(%rbp),%edx
  4006ed:	81 fa dd da 0b 12    	cmp    $0x120bdadd,%edx
  ...
  40070f:	c7 45 d8 59 21 5f 46 	movl   $0x465f2159,-0x28(%rbp)
