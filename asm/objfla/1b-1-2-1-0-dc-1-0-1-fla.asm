...
./fla//1b-1-2-1-0-dc-1-0-1-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  4005f0:	e9 9d 00 00 00       	jmpq   400692 <main+0x192>
  4005f5:	b8 58 fc e6 a1       	mov    $0xa1e6fc58,%eax
  4005fa:	b9 18 eb 28 a1       	mov    $0xa128eb18,%ecx
  4005ff:	83 7d f8 02          	cmpl   $0x2,-0x8(%rbp)
  400603:	0f 4c c1             	cmovl  %ecx,%eax
  400606:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400609:	e9 84 00 00 00       	jmpq   400692 <main+0x192>
  40060e:	48 bf 24 07 40 00 00 	movabs $0x400724,%rdi
  400615:	00 00 00 
  400618:	b0 00                	mov    $0x0,%al
  40061a:	e8 e1 fd ff ff       	callq  400400 <printf@plt>
  40061f:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
  400626:	c7 45 e4 c0 b7 fc e1 	movl   $0xe1fcb7c0,-0x1c(%rbp)
  40062d:	89 45 c0             	mov    %eax,-0x40(%rbp)
  400630:	e9 5d 00 00 00       	jmpq   400692 <main+0x192>
  400635:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400638:	03 45 e8             	add    -0x18(%rbp),%eax
  40063b:	89 45 e8             	mov    %eax,-0x18(%rbp)
  40063e:	c7 45 e4 b6 72 56 ce 	movl   $0xce5672b6,-0x1c(%rbp)
  400645:	e9 48 00 00 00       	jmpq   400692 <main+0x192>
  40064a:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40064d:	83 c0 01             	add    $0x1,%eax
  400650:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400653:	c7 45 e4 f9 f4 38 bf 	movl   $0xbf38f4f9,-0x1c(%rbp)
  40065a:	e9 33 00 00 00       	jmpq   400692 <main+0x192>
  40065f:	48 bf 3e 07 40 00 00 	movabs $0x40073e,%rdi
  400666:	00 00 00 
  ...
  40067a:	c7 45 e4 c0 b7 fc e1 	movl   $0xe1fcb7c0,-0x1c(%rbp)
  400681:	89 45 bc             	mov    %eax,-0x44(%rbp)
  400684:	e9 09 00 00 00       	jmpq   400692 <main+0x192>
  400689:	8b 45 fc             	mov    -0x4(%rbp),%eax
  40068c:	48 83 c4 50          	add    $0x50,%rsp
  400690:	5d                   	pop    %rbp
  400691:	c3                   	retq   
  400692:	e9 94 fe ff ff       	jmpq   40052b <main+0x2b>
