...
./fla//1b-1-2-1-1-eqsum127_dep-1-0-1-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  4005d0:	b8 19 6b 71 28       	mov    $0x28716b19,%eax
  4005d5:	b9 ba d0 42 7c       	mov    $0x7c42d0ba,%ecx
  ...
  4005f5:	b8 bd 0a 57 b7       	mov    $0xb7570abd,%eax
  4005fa:	b9 81 23 b3 46       	mov    $0x46b32381,%ecx
  4005ff:	81 7d e8 c0 1f 00 00 	cmpl   $0x1fc0,-0x18(%rbp)
  400606:	0f 44 c1             	cmove  %ecx,%eax
  ...
  40061b:	c7 45 e4 cd b7 58 3f 	movl   $0x3f58b7cd,-0x1c(%rbp)
  ...
  400630:	c7 45 e4 cd b7 58 3f 	movl   $0x3f58b7cd,-0x1c(%rbp)
  400637:	e9 42 00 00 00       	jmpq   40067e <main+0x17e>
  40063c:	c7 45 e4 52 6d 73 f2 	movl   $0xf2736d52,-0x1c(%rbp)
  ...
  400651:	c7 45 e4 0f 10 6b 22 	movl   $0x226b100f,-0x1c(%rbp)
