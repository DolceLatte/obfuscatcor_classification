...
./fla//bkdrhash-fla.o:     file format elf64-x86-64
...
0000000000400540 <BKDRHash>:
  ...
  400567:	c7 45 e4 72 5c 57 1e 	movl   $0x1e575c72,-0x1c(%rbp)
  40056e:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  400571:	89 c1                	mov    %eax,%ecx
  400573:	81 e9 e8 37 e4 ab    	sub    $0xabe437e8,%ecx
  400579:	89 45 e0             	mov    %eax,-0x20(%rbp)
  40057c:	89 4d dc             	mov    %ecx,-0x24(%rbp)
  40057f:	0f 84 a7 00 00 00    	je     40062c <BKDRHash+0xec>
  400585:	e9 00 00 00 00       	jmpq   40058a <BKDRHash+0x4a>
  40058a:	8b 45 e0             	mov    -0x20(%rbp),%eax
  40058d:	2d d6 e8 ce dd       	sub    $0xddcee8d6,%eax
  400592:	89 45 d8             	mov    %eax,-0x28(%rbp)
  400595:	0f 84 70 00 00 00    	je     40060b <BKDRHash+0xcb>
  40059b:	e9 00 00 00 00       	jmpq   4005a0 <BKDRHash+0x60>
  4005a0:	8b 45 e0             	mov    -0x20(%rbp),%eax
  4005a3:	2d 2e 00 1e 05       	sub    $0x51e002e,%eax
  4005a8:	89 45 d4             	mov    %eax,-0x2c(%rbp)
  4005ab:	0f 84 3b 00 00 00    	je     4005ec <BKDRHash+0xac>
  4005b1:	e9 00 00 00 00       	jmpq   4005b6 <BKDRHash+0x76>
  4005b6:	8b 45 e0             	mov    -0x20(%rbp),%eax
  4005b9:	2d 72 5c 57 1e       	sub    $0x1e575c72,%eax
  4005be:	89 45 d0             	mov    %eax,-0x30(%rbp)
  4005c1:	0f 84 0a 00 00 00    	je     4005d1 <BKDRHash+0x91>
  4005c7:	e9 00 00 00 00       	jmpq   4005cc <BKDRHash+0x8c>
  4005cc:	e9 60 00 00 00       	jmpq   400631 <BKDRHash+0xf1>
  4005d1:	b8 e8 37 e4 ab       	mov    $0xabe437e8,%eax
  4005d6:	b9 2e 00 1e 05       	mov    $0x51e002e,%ecx
  ...
  4005e7:	e9 45 00 00 00       	jmpq   400631 <BKDRHash+0xf1>
  4005ec:	8b 45 ec             	mov    -0x14(%rbp),%eax
  4005ef:	0f af 45 f0          	imul   -0x10(%rbp),%eax
  4005f3:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
  4005f7:	0f be 11             	movsbl (%rcx),%edx
  4005fa:	01 d0                	add    %edx,%eax
  4005fc:	89 45 ec             	mov    %eax,-0x14(%rbp)
  4005ff:	c7 45 e4 d6 e8 ce dd 	movl   $0xddcee8d6,-0x1c(%rbp)
  400606:	e9 26 00 00 00       	jmpq   400631 <BKDRHash+0xf1>
  40060b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  40060f:	48 83 c0 01          	add    $0x1,%rax
  400613:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  400617:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  40061a:	83 c1 01             	add    $0x1,%ecx
  40061d:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  400620:	c7 45 e4 72 5c 57 1e 	movl   $0x1e575c72,-0x1c(%rbp)
  400627:	e9 05 00 00 00       	jmpq   400631 <BKDRHash+0xf1>
  40062c:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40062f:	5d                   	pop    %rbp
  400630:	c3                   	retq   
  400631:	e9 38 ff ff ff       	jmpq   40056e <BKDRHash+0x2e>
...
0000000000400640 <main>:
  ...
  4006b2:	2d 34 48 2f f2       	sub    $0xf22f4834,%eax
  ...
  4006c8:	2d a5 5e fb 37       	sub    $0x37fb5ea5,%eax
  4006cd:	89 45 c0             	mov    %eax,-0x40(%rbp)
  4006d0:	0f 84 28 00 00 00    	je     4006fe <main+0xbe>
  4006d6:	e9 00 00 00 00       	jmpq   4006db <main+0x9b>
  4006db:	e9 46 00 00 00       	jmpq   400726 <main+0xe6>
  4006e0:	b8 88 f4 e4 a0       	mov    $0xa0e4f488,%eax
  4006e5:	b9 a5 5e fb 37       	mov    $0x37fb5ea5,%ecx
  4006ea:	8b 55 fc             	mov    -0x4(%rbp),%edx
  4006ed:	81 fa b2 82 92 bd    	cmp    $0xbd9282b2,%edx
  ...
  40070f:	c7 45 d8 88 f4 e4 a0 	movl   $0xa0e4f488,-0x28(%rbp)
