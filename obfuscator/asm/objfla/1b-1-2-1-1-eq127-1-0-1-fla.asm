...
./fla//1b-1-2-1-1-eq127-1-0-1-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  4005f0:	e9 90 00 00 00       	jmpq   400685 <main+0x185>
  4005f5:	b8 90 4b 14 06       	mov    $0x6144b90,%eax
  4005fa:	b9 7d 68 e3 0d       	mov    $0xde3687d,%ecx
  4005ff:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
  400603:	48 8b 52 08          	mov    0x8(%rdx),%rdx
  400607:	0f be 32             	movsbl (%rdx),%esi
  40060a:	83 fe 7f             	cmp    $0x7f,%esi
  40060d:	0f 44 c1             	cmove  %ecx,%eax
  400610:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400613:	e9 6d 00 00 00       	jmpq   400685 <main+0x185>
  400618:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40061b:	03 45 e8             	add    -0x18(%rbp),%eax
  40061e:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400621:	c7 45 e4 7d 69 3a f9 	movl   $0xf93a697d,-0x1c(%rbp)
  400628:	e9 58 00 00 00       	jmpq   400685 <main+0x185>
  40062d:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400630:	0f af 45 e8          	imul   -0x18(%rbp),%eax
  400634:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400637:	c7 45 e4 7d 69 3a f9 	movl   $0xf93a697d,-0x1c(%rbp)
  40063e:	e9 42 00 00 00       	jmpq   400685 <main+0x185>
  400643:	c7 45 e4 e2 d8 74 22 	movl   $0x2274d8e2,-0x1c(%rbp)
  40064a:	e9 36 00 00 00       	jmpq   400685 <main+0x185>
  40064f:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400652:	83 c0 01             	add    $0x1,%eax
  400655:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400658:	c7 45 e4 36 79 a0 34 	movl   $0x34a07936,-0x1c(%rbp)
  40065f:	e9 21 00 00 00       	jmpq   400685 <main+0x185>
  400664:	48 bf 14 07 40 00 00 	movabs $0x400714,%rdi
  40066b:	00 00 00 
  40066e:	8b 75 e8             	mov    -0x18(%rbp),%esi
  400671:	b0 00                	mov    $0x0,%al
  400673:	e8 88 fd ff ff       	callq  400400 <printf@plt>
  400678:	31 f6                	xor    %esi,%esi
  40067a:	89 45 c0             	mov    %eax,-0x40(%rbp)
  40067d:	89 f0                	mov    %esi,%eax
  40067f:	48 83 c4 40          	add    $0x40,%rsp
  400683:	5d                   	pop    %rbp
  400684:	c3                   	retq   
  400685:	e9 a1 fe ff ff       	jmpq   40052b <main+0x2b>
