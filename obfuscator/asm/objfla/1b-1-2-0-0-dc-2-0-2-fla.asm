...
./fla//1b-1-2-0-0-dc-2-0-2-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400576:	2d 55 33 15 29       	sub    $0x29153355,%eax
  40057b:	89 45 cc             	mov    %eax,-0x34(%rbp)
  40057e:	0f 84 f5 00 00 00    	je     400679 <main+0x179>
  400584:	e9 00 00 00 00       	jmpq   400589 <main+0x89>
  400589:	8b 45 dc             	mov    -0x24(%rbp),%eax
  40058c:	2d ec fe 65 4b       	sub    $0x4b65feec,%eax
  400591:	89 45 c8             	mov    %eax,-0x38(%rbp)
  400594:	0f 84 84 00 00 00    	je     40061e <main+0x11e>
  40059a:	e9 00 00 00 00       	jmpq   40059f <main+0x9f>
  40059f:	8b 45 dc             	mov    -0x24(%rbp),%eax
  4005a2:	2d 12 47 60 65       	sub    $0x65604712,%eax
  4005a7:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  4005aa:	0f 84 bd 00 00 00    	je     40066d <main+0x16d>
  4005b0:	e9 00 00 00 00       	jmpq   4005b5 <main+0xb5>
  4005b5:	8b 45 dc             	mov    -0x24(%rbp),%eax
  4005b8:	2d 06 79 e6 6b       	sub    $0x6be67906,%eax
  4005bd:	89 45 c0             	mov    %eax,-0x40(%rbp)
  4005c0:	0f 84 c8 00 00 00    	je     40068e <main+0x18e>
  4005c6:	e9 00 00 00 00       	jmpq   4005cb <main+0xcb>
  4005cb:	8b 45 dc             	mov    -0x24(%rbp),%eax
  4005ce:	2d b8 d5 04 79       	sub    $0x7904d5b8,%eax
  4005d3:	89 45 bc             	mov    %eax,-0x44(%rbp)
  4005d6:	0f 84 67 00 00 00    	je     400643 <main+0x143>
  4005dc:	e9 00 00 00 00       	jmpq   4005e1 <main+0xe1>
  4005e1:	e9 c9 00 00 00       	jmpq   4006af <main+0x1af>
  4005e6:	b8 06 79 e6 6b       	mov    $0x6be67906,%eax
  4005eb:	b9 10 c1 68 dd       	mov    $0xdd68c110,%ecx
  ...
  400603:	89 45 e0             	mov    %eax,-0x20(%rbp)
  400606:	e9 a4 00 00 00       	jmpq   4006af <main+0x1af>
  40060b:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%rbp)
  400612:	c7 45 e0 ec fe 65 4b 	movl   $0x4b65feec,-0x20(%rbp)
  400619:	e9 91 00 00 00       	jmpq   4006af <main+0x1af>
  40061e:	b8 12 47 60 65       	mov    $0x65604712,%eax
  400623:	b9 b8 d5 04 79       	mov    $0x7904d5b8,%ecx
  400628:	8b 55 e8             	mov    -0x18(%rbp),%edx
  40062b:	48 8b 75 f0          	mov    -0x10(%rbp),%rsi
  40062f:	48 8b 76 08          	mov    0x8(%rsi),%rsi
  400633:	0f be 3e             	movsbl (%rsi),%edi
  400636:	39 fa                	cmp    %edi,%edx
  400638:	0f 4c c1             	cmovl  %ecx,%eax
  40063b:	89 45 e0             	mov    %eax,-0x20(%rbp)
  40063e:	e9 6c 00 00 00       	jmpq   4006af <main+0x1af>
  400643:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400646:	03 45 e4             	add    -0x1c(%rbp),%eax
  400649:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  40064c:	c7 45 e0 23 74 e1 b3 	movl   $0xb3e17423,-0x20(%rbp)
  400653:	e9 57 00 00 00       	jmpq   4006af <main+0x1af>
  400658:	8b 45 e8             	mov    -0x18(%rbp),%eax
  40065b:	83 c0 01             	add    $0x1,%eax
  40065e:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400661:	c7 45 e0 ec fe 65 4b 	movl   $0x4b65feec,-0x20(%rbp)
  400668:	e9 42 00 00 00       	jmpq   4006af <main+0x1af>
  40066d:	c7 45 e0 55 33 15 29 	movl   $0x29153355,-0x20(%rbp)
  400674:	e9 36 00 00 00       	jmpq   4006af <main+0x1af>
  400679:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40067c:	83 c0 01             	add    $0x1,%eax
  40067f:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400682:	c7 45 e0 54 0b 53 06 	movl   $0x6530b54,-0x20(%rbp)
  400689:	e9 21 00 00 00       	jmpq   4006af <main+0x1af>
  40068e:	48 bf 44 07 40 00 00 	movabs $0x400744,%rdi
  400695:	00 00 00 
  400698:	8b 75 e4             	mov    -0x1c(%rbp),%esi
  40069b:	b0 00                	mov    $0x0,%al
  40069d:	e8 5e fd ff ff       	callq  400400 <printf@plt>
  4006a2:	31 f6                	xor    %esi,%esi
  4006a4:	89 45 b8             	mov    %eax,-0x48(%rbp)
  4006a7:	89 f0                	mov    %esi,%eax
  4006a9:	48 83 c4 50          	add    $0x50,%rsp
  4006ad:	5d                   	pop    %rbp
  4006ae:	c3                   	retq   
  4006af:	e9 77 fe ff ff       	jmpq   40052b <main+0x2b>
