...
./fla//1b-1-2-1-1-gtsum127_dep-1-0-1-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400524:	c7 45 e4 8a f6 44 a5 	movl   $0xa544f68a,-0x1c(%rbp)
  40052b:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  40052e:	89 c1                	mov    %eax,%ecx
  400530:	81 e9 dc 71 b6 87    	sub    $0x87b671dc,%ecx
  ...
  40054a:	2d 8a f6 44 a5       	sub    $0xa544f68a,%eax
  40054f:	89 45 d8             	mov    %eax,-0x28(%rbp)
  400552:	0f 84 78 00 00 00    	je     4005d0 <main+0xd0>
  400558:	e9 00 00 00 00       	jmpq   40055d <main+0x5d>
  40055d:	8b 45 e0             	mov    -0x20(%rbp),%eax
  400560:	2d 1a d3 7d c5       	sub    $0xc57dd31a,%eax
  ...
  400576:	2d 17 35 81 e4       	sub    $0xe4813517,%eax
  40057b:	89 45 d0             	mov    %eax,-0x30(%rbp)
  40057e:	0f 84 8d 00 00 00    	je     400611 <main+0x111>
  400584:	e9 00 00 00 00       	jmpq   400589 <main+0x89>
  400589:	8b 45 e0             	mov    -0x20(%rbp),%eax
  40058c:	2d 50 17 48 34       	sub    $0x34481750,%eax
  400591:	89 45 cc             	mov    %eax,-0x34(%rbp)
  400594:	0f 84 8d 00 00 00    	je     400627 <main+0x127>
  40059a:	e9 00 00 00 00       	jmpq   40059f <main+0x9f>
  40059f:	8b 45 e0             	mov    -0x20(%rbp),%eax
  4005a2:	2d 77 92 68 48       	sub    $0x48689277,%eax
  4005a7:	89 45 c8             	mov    %eax,-0x38(%rbp)
  4005aa:	0f 84 8c 00 00 00    	je     40063c <main+0x13c>
  4005b0:	e9 00 00 00 00       	jmpq   4005b5 <main+0xb5>
  4005b5:	8b 45 e0             	mov    -0x20(%rbp),%eax
  4005b8:	2d 6e 60 aa 65       	sub    $0x65aa606e,%eax
  4005bd:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  4005c0:	0f 84 97 00 00 00    	je     40065d <main+0x15d>
  4005c6:	e9 00 00 00 00       	jmpq   4005cb <main+0xcb>
  4005cb:	e9 ae 00 00 00       	jmpq   40067e <main+0x17e>
  4005d0:	b8 6e 60 aa 65       	mov    $0x65aa606e,%eax
  4005d5:	b9 dc 71 b6 87       	mov    $0x87b671dc,%ecx
  ...
  4005f0:	e9 89 00 00 00       	jmpq   40067e <main+0x17e>
  4005f5:	b8 50 17 48 34       	mov    $0x34481750,%eax
  4005fa:	b9 17 35 81 e4       	mov    $0xe4813517,%ecx
  4005ff:	81 7d e8 c0 1f 00 00 	cmpl   $0x1fc0,-0x18(%rbp)
  400606:	0f 4f c1             	cmovg  %ecx,%eax
  400609:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  40060c:	e9 6d 00 00 00       	jmpq   40067e <main+0x17e>
  400611:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400614:	0f af 45 e8          	imul   -0x18(%rbp),%eax
  400618:	89 45 e8             	mov    %eax,-0x18(%rbp)
  40061b:	c7 45 e4 77 92 68 48 	movl   $0x48689277,-0x1c(%rbp)
  400622:	e9 57 00 00 00       	jmpq   40067e <main+0x17e>
  400627:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40062a:	03 45 e8             	add    -0x18(%rbp),%eax
  40062d:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400630:	c7 45 e4 77 92 68 48 	movl   $0x48689277,-0x1c(%rbp)
  400637:	e9 42 00 00 00       	jmpq   40067e <main+0x17e>
  40063c:	c7 45 e4 1a d3 7d c5 	movl   $0xc57dd31a,-0x1c(%rbp)
  400643:	e9 36 00 00 00       	jmpq   40067e <main+0x17e>
  400648:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40064b:	83 c0 01             	add    $0x1,%eax
  40064e:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400651:	c7 45 e4 8a f6 44 a5 	movl   $0xa544f68a,-0x1c(%rbp)
  400658:	e9 21 00 00 00       	jmpq   40067e <main+0x17e>
  40065d:	48 bf 14 07 40 00 00 	movabs $0x400714,%rdi
  400664:	00 00 00 
  400667:	8b 75 e8             	mov    -0x18(%rbp),%esi
  40066a:	b0 00                	mov    $0x0,%al
  40066c:	e8 8f fd ff ff       	callq  400400 <printf@plt>
  400671:	31 f6                	xor    %esi,%esi
  400673:	89 45 c0             	mov    %eax,-0x40(%rbp)
  400676:	89 f0                	mov    %esi,%eax
  400678:	48 83 c4 40          	add    $0x40,%rsp
  40067c:	5d                   	pop    %rbp
  40067d:	c3                   	retq   
  40067e:	e9 a8 fe ff ff       	jmpq   40052b <main+0x2b>
