...
./fla//1b-4-1-0-0-dc-1-1-0-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400524:	c7 45 e4 56 f6 a4 57 	movl   $0x57a4f656,-0x1c(%rbp)
  40052b:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  40052e:	89 c1                	mov    %eax,%ecx
  400530:	81 e9 06 4a 49 c7    	sub    $0xc7494a06,%ecx
  400536:	89 45 e0             	mov    %eax,-0x20(%rbp)
  400539:	89 4d dc             	mov    %ecx,-0x24(%rbp)
  40053c:	0f 84 91 00 00 00    	je     4005d3 <main+0xd3>
  400542:	e9 00 00 00 00       	jmpq   400547 <main+0x47>
  400547:	8b 45 e0             	mov    -0x20(%rbp),%eax
  40054a:	2d b2 8e 7a e8       	sub    $0xe87a8eb2,%eax
  40054f:	89 45 d8             	mov    %eax,-0x28(%rbp)
  400552:	0f 84 66 00 00 00    	je     4005be <main+0xbe>
  400558:	e9 00 00 00 00       	jmpq   40055d <main+0x5d>
  40055d:	8b 45 e0             	mov    -0x20(%rbp),%eax
  400560:	2d 66 3d ad 11       	sub    $0x11ad3d66,%eax
  400565:	89 45 d4             	mov    %eax,-0x2c(%rbp)
  400568:	0f 84 3b 00 00 00    	je     4005a9 <main+0xa9>
  40056e:	e9 00 00 00 00       	jmpq   400573 <main+0x73>
  400573:	8b 45 e0             	mov    -0x20(%rbp),%eax
  400576:	2d 56 f6 a4 57       	sub    $0x57a4f656,%eax
  40057b:	89 45 d0             	mov    %eax,-0x30(%rbp)
  40057e:	0f 84 0a 00 00 00    	je     40058e <main+0x8e>
  400584:	e9 00 00 00 00       	jmpq   400589 <main+0x89>
  400589:	e9 66 00 00 00       	jmpq   4005f4 <main+0xf4>
  40058e:	b8 06 4a 49 c7       	mov    $0xc7494a06,%eax
  400593:	b9 66 3d ad 11       	mov    $0x11ad3d66,%ecx
  400598:	8b 55 ec             	mov    -0x14(%rbp),%edx
  40059b:	3b 55 f8             	cmp    -0x8(%rbp),%edx
  40059e:	0f 4c c1             	cmovl  %ecx,%eax
  4005a1:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  4005a4:	e9 4b 00 00 00       	jmpq   4005f4 <main+0xf4>
  4005a9:	8b 45 ec             	mov    -0x14(%rbp),%eax
  4005ac:	03 45 e8             	add    -0x18(%rbp),%eax
  4005af:	89 45 e8             	mov    %eax,-0x18(%rbp)
  4005b2:	c7 45 e4 b2 8e 7a e8 	movl   $0xe87a8eb2,-0x1c(%rbp)
  4005b9:	e9 36 00 00 00       	jmpq   4005f4 <main+0xf4>
  4005be:	8b 45 ec             	mov    -0x14(%rbp),%eax
  4005c1:	83 c0 01             	add    $0x1,%eax
  4005c4:	89 45 ec             	mov    %eax,-0x14(%rbp)
  4005c7:	c7 45 e4 56 f6 a4 57 	movl   $0x57a4f656,-0x1c(%rbp)
  4005ce:	e9 21 00 00 00       	jmpq   4005f4 <main+0xf4>
  4005d3:	48 bf 84 06 40 00 00 	movabs $0x400684,%rdi
  4005da:	00 00 00 
  4005dd:	8b 75 e8             	mov    -0x18(%rbp),%esi
  4005e0:	b0 00                	mov    $0x0,%al
  4005e2:	e8 19 fe ff ff       	callq  400400 <printf@plt>
  4005e7:	31 f6                	xor    %esi,%esi
  4005e9:	89 45 cc             	mov    %eax,-0x34(%rbp)
  4005ec:	89 f0                	mov    %esi,%eax
  4005ee:	48 83 c4 40          	add    $0x40,%rsp
  4005f2:	5d                   	pop    %rbp
  4005f3:	c3                   	retq   
  4005f4:	e9 32 ff ff ff       	jmpq   40052b <main+0x2b>
