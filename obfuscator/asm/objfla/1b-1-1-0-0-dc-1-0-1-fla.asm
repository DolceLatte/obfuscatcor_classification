...
./fla//1b-1-1-0-0-dc-1-0-1-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400524:	c7 45 e4 cf 78 12 dc 	movl   $0xdc1278cf,-0x1c(%rbp)
  40052b:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  40052e:	89 c1                	mov    %eax,%ecx
  400530:	81 e9 e0 02 94 82    	sub    $0x829402e0,%ecx
  400536:	89 45 e0             	mov    %eax,-0x20(%rbp)
  400539:	89 4d dc             	mov    %ecx,-0x24(%rbp)
  40053c:	0f 84 9b 00 00 00    	je     4005dd <main+0xdd>
  400542:	e9 00 00 00 00       	jmpq   400547 <main+0x47>
  400547:	8b 45 e0             	mov    -0x20(%rbp),%eax
  40054a:	2d cf 78 12 dc       	sub    $0xdc1278cf,%eax
  40054f:	89 45 d8             	mov    %eax,-0x28(%rbp)
  400552:	0f 84 36 00 00 00    	je     40058e <main+0x8e>
  400558:	e9 00 00 00 00       	jmpq   40055d <main+0x5d>
  40055d:	8b 45 e0             	mov    -0x20(%rbp),%eax
  400560:	2d 32 78 f0 4f       	sub    $0x4ff07832,%eax
  400565:	89 45 d4             	mov    %eax,-0x2c(%rbp)
  400568:	0f 84 45 00 00 00    	je     4005b3 <main+0xb3>
  40056e:	e9 00 00 00 00       	jmpq   400573 <main+0x73>
  400573:	8b 45 e0             	mov    -0x20(%rbp),%eax
  400576:	2d 32 5c b0 69       	sub    $0x69b05c32,%eax
  40057b:	89 45 d0             	mov    %eax,-0x30(%rbp)
  40057e:	0f 84 44 00 00 00    	je     4005c8 <main+0xc8>
  400584:	e9 00 00 00 00       	jmpq   400589 <main+0x89>
  400589:	e9 70 00 00 00       	jmpq   4005fe <main+0xfe>
  40058e:	b8 e0 02 94 82       	mov    $0x829402e0,%eax
  400593:	b9 32 78 f0 4f       	mov    $0x4ff07832,%ecx
  400598:	8b 55 ec             	mov    -0x14(%rbp),%edx
  40059b:	48 8b 75 f0          	mov    -0x10(%rbp),%rsi
  40059f:	48 8b 76 08          	mov    0x8(%rsi),%rsi
  4005a3:	0f be 3e             	movsbl (%rsi),%edi
  4005a6:	39 fa                	cmp    %edi,%edx
  4005a8:	0f 4c c1             	cmovl  %ecx,%eax
  4005ab:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  4005ae:	e9 4b 00 00 00       	jmpq   4005fe <main+0xfe>
  4005b3:	8b 45 ec             	mov    -0x14(%rbp),%eax
  4005b6:	03 45 e8             	add    -0x18(%rbp),%eax
  4005b9:	89 45 e8             	mov    %eax,-0x18(%rbp)
  4005bc:	c7 45 e4 32 5c b0 69 	movl   $0x69b05c32,-0x1c(%rbp)
  4005c3:	e9 36 00 00 00       	jmpq   4005fe <main+0xfe>
  4005c8:	8b 45 ec             	mov    -0x14(%rbp),%eax
  4005cb:	83 c0 01             	add    $0x1,%eax
  4005ce:	89 45 ec             	mov    %eax,-0x14(%rbp)
  4005d1:	c7 45 e4 cf 78 12 dc 	movl   $0xdc1278cf,-0x1c(%rbp)
  4005d8:	e9 21 00 00 00       	jmpq   4005fe <main+0xfe>
  4005dd:	48 bf 94 06 40 00 00 	movabs $0x400694,%rdi
  4005e4:	00 00 00 
  4005e7:	8b 75 e8             	mov    -0x18(%rbp),%esi
  4005ea:	b0 00                	mov    $0x0,%al
  4005ec:	e8 0f fe ff ff       	callq  400400 <printf@plt>
  4005f1:	31 f6                	xor    %esi,%esi
  4005f3:	89 45 cc             	mov    %eax,-0x34(%rbp)
  4005f6:	89 f0                	mov    %esi,%eax
  4005f8:	48 83 c4 40          	add    $0x40,%rsp
  4005fc:	5d                   	pop    %rbp
  4005fd:	c3                   	retq   
  4005fe:	e9 28 ff ff ff       	jmpq   40052b <main+0x2b>
