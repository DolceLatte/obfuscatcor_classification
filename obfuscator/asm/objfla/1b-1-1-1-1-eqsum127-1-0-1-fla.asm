...
./fla//1b-1-1-1-1-eqsum127-1-0-1-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  4005b8:	2d cc 1b 32 79       	sub    $0x79321bcc,%eax
  4005bd:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  4005c0:	0f 84 75 00 00 00    	je     40063b <main+0x13b>
  4005c6:	e9 00 00 00 00       	jmpq   4005cb <main+0xcb>
  4005cb:	e9 b9 00 00 00       	jmpq   400689 <main+0x189>
  4005d0:	b8 1e 46 b5 95       	mov    $0x95b5461e,%eax
  4005d5:	b9 d3 67 bc 3e       	mov    $0x3ebc67d3,%ecx
  ...
  4005fe:	c7 45 e4 a5 34 c5 00 	movl   $0xc534a5,-0x1c(%rbp)
  ...
  400613:	c7 45 e4 05 fb 40 73 	movl   $0x7340fb05,-0x1c(%rbp)
  40061a:	e9 6a 00 00 00       	jmpq   400689 <main+0x189>
  40061f:	b8 89 1e 33 bd       	mov    $0xbd331e89,%eax
  400624:	b9 cc 1b 32 79       	mov    $0x79321bcc,%ecx
  400629:	81 7d e8 c0 1f 00 00 	cmpl   $0x1fc0,-0x18(%rbp)
  400630:	0f 44 c1             	cmove  %ecx,%eax
  ...
  40064f:	c7 45 e4 c6 ee 46 72 	movl   $0x7246eec6,-0x1c(%rbp)
  ...
  400672:	c7 45 e4 c6 ee 46 72 	movl   $0x7246eec6,-0x1c(%rbp)
