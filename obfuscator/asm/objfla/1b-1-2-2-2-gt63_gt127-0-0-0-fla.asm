...
./fla//1b-1-2-2-2-gt63_gt127-0-0-0-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	c7 45 e0 f8 56 90 83 	movl   $0x839056f8,-0x20(%rbp)
  400531:	8b 45 e0             	mov    -0x20(%rbp),%eax
  400534:	89 c1                	mov    %eax,%ecx
  400536:	81 e9 f8 56 90 83    	sub    $0x839056f8,%ecx
  ...
  400602:	b9 9e 8a e6 7e       	mov    $0x7ee68a9e,%ecx
  400607:	ba fe 24 a0 8d       	mov    $0x8da024fe,%edx
  40060c:	0f b6 75 e7          	movzbl -0x19(%rbp),%esi
  400610:	83 fe 7f             	cmp    $0x7f,%esi
  400613:	0f 4f ca             	cmovg  %edx,%ecx
  400616:	89 4d e0             	mov    %ecx,-0x20(%rbp)
  400619:	89 45 bc             	mov    %eax,-0x44(%rbp)
  40061c:	e9 74 00 00 00       	jmpq   400695 <main+0x195>
  400621:	48 bf 2e 07 40 00 00 	movabs $0x40072e,%rdi
  400628:	00 00 00 
  40062b:	b0 00                	mov    $0x0,%al
  40062d:	e8 ce fd ff ff       	callq  400400 <printf@plt>
  400632:	c7 45 e0 5c 15 c8 c2 	movl   $0xc2c8155c,-0x20(%rbp)
  400639:	89 45 b8             	mov    %eax,-0x48(%rbp)
  40063c:	e9 54 00 00 00       	jmpq   400695 <main+0x195>
  400641:	48 bf 38 07 40 00 00 	movabs $0x400738,%rdi
  400648:	00 00 00 
  40064b:	b0 00                	mov    $0x0,%al
  40064d:	e8 ae fd ff ff       	callq  400400 <printf@plt>
  400652:	c7 45 e0 5c 15 c8 c2 	movl   $0xc2c8155c,-0x20(%rbp)
  400659:	89 45 b4             	mov    %eax,-0x4c(%rbp)
  40065c:	e9 34 00 00 00       	jmpq   400695 <main+0x195>
  400661:	c7 45 e0 b4 24 2e bb 	movl   $0xbb2e24b4,-0x20(%rbp)
  ...
  40067e:	c7 45 e0 b4 24 2e bb 	movl   $0xbb2e24b4,-0x20(%rbp)
