...
./fla//1b-1-2-2-2-gt63_eq127-0-0-0-fla.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40057c:	2d 05 e0 3a e4       	sub    $0xe43ae005,%eax
  400581:	89 45 cc             	mov    %eax,-0x34(%rbp)
  400584:	0f 84 4c 00 00 00    	je     4005d6 <main+0xd6>
  40058a:	e9 00 00 00 00       	jmpq   40058f <main+0x8f>
  40058f:	8b 45 dc             	mov    -0x24(%rbp),%eax
  400592:	2d bb dc 93 0c       	sub    $0xc93dcbb,%eax
  ...
  4005a8:	2d 7e 19 16 25       	sub    $0x2516197e,%eax
  ...
  4005be:	2d 88 93 3d 26       	sub    $0x263d9388,%eax
  4005c3:	89 45 c0             	mov    %eax,-0x40(%rbp)
  4005c6:	0f 84 55 00 00 00    	je     400621 <main+0x121>
  4005cc:	e9 00 00 00 00       	jmpq   4005d1 <main+0xd1>
  4005d1:	e9 bf 00 00 00       	jmpq   400695 <main+0x195>
  4005d6:	b8 7e 19 16 25       	mov    $0x2516197e,%eax
  4005db:	b9 40 37 1f cb       	mov    $0xcb1f3740,%ecx
  ...
  400602:	b9 4b de db cb       	mov    $0xcbdbde4b,%ecx
  400607:	ba 88 93 3d 26       	mov    $0x263d9388,%edx
  40060c:	0f b6 75 e7          	movzbl -0x19(%rbp),%esi
  400610:	83 fe 7f             	cmp    $0x7f,%esi
  400613:	0f 44 ca             	cmove  %edx,%ecx
  ...
  400632:	c7 45 e0 4b 6b 12 b8 	movl   $0xb8126b4b,-0x20(%rbp)
  ...
  400652:	c7 45 e0 4b 6b 12 b8 	movl   $0xb8126b4b,-0x20(%rbp)
  400659:	89 45 b4             	mov    %eax,-0x4c(%rbp)
  40065c:	e9 34 00 00 00       	jmpq   400695 <main+0x195>
  400661:	c7 45 e0 bb dc 93 0c 	movl   $0xc93dcbb,-0x20(%rbp)
  ...
  40067e:	c7 45 e0 bb dc 93 0c 	movl   $0xc93dcbb,-0x20(%rbp)
