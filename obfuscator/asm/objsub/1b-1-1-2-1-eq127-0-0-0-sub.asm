...
./sub//1b-1-1-2-1-eq127-0-0-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400520:	48 bf 24 06 40 00 00 	movabs $0x400624,%rdi
  400527:	00 00 00 
  40052a:	b0 00                	mov    $0x0,%al
  40052c:	e8 cf fe ff ff       	callq  400400 <printf@plt>
  400531:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
  400538:	89 45 e8             	mov    %eax,-0x18(%rbp)
  40053b:	e9 4e 00 00 00       	jmpq   40058e <main+0x8e>
  400540:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  400544:	48 8b 40 08          	mov    0x8(%rax),%rax
  400548:	8a 08                	mov    (%rax),%cl
  40054a:	88 4d ef             	mov    %cl,-0x11(%rbp)
  40054d:	0f b6 55 ef          	movzbl -0x11(%rbp),%edx
  400551:	83 fa 7f             	cmp    $0x7f,%edx
  400554:	0f 85 19 00 00 00    	jne    400573 <main+0x73>
  40055a:	48 bf 42 06 40 00 00 	movabs $0x400642,%rdi
  400561:	00 00 00 
  400564:	b0 00                	mov    $0x0,%al
  400566:	e8 95 fe ff ff       	callq  400400 <printf@plt>
  40056b:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  40056e:	e9 14 00 00 00       	jmpq   400587 <main+0x87>
  400573:	48 bf 47 06 40 00 00 	movabs $0x400647,%rdi
  40057a:	00 00 00 
  40057d:	b0 00                	mov    $0x0,%al
  40057f:	e8 7c fe ff ff       	callq  400400 <printf@plt>
  400584:	89 45 e0             	mov    %eax,-0x20(%rbp)
  400587:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  40058e:	8b 45 fc             	mov    -0x4(%rbp),%eax
  400591:	48 83 c4 20          	add    $0x20,%rsp
  400595:	5d                   	pop    %rbp
  400596:	c3                   	retq   
