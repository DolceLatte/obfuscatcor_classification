...
./sub//1b-1-2-0-0-dc-2-0-2-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400534:	0f 8d 6b 00 00 00    	jge    4005a5 <main+0xa5>
  40053a:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%rbp)
  400541:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400544:	48 8b 4d f0          	mov    -0x10(%rbp),%rcx
  400548:	48 8b 49 08          	mov    0x8(%rcx),%rcx
  40054c:	0f be 11             	movsbl (%rcx),%edx
  40054f:	39 d0                	cmp    %edx,%eax
  400551:	0f 8d 2f 00 00 00    	jge    400586 <main+0x86>
  400557:	8b 45 e8             	mov    -0x18(%rbp),%eax
  40055a:	8b 4d e4             	mov    -0x1c(%rbp),%ecx
  40055d:	81 c1 f1 c0 f2 e3    	add    $0xe3f2c0f1,%ecx
  400563:	01 c1                	add    %eax,%ecx
  400565:	81 e9 f1 c0 f2 e3    	sub    $0xe3f2c0f1,%ecx
  40056b:	89 4d e4             	mov    %ecx,-0x1c(%rbp)
  40056e:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400571:	05 12 b5 9b 9d       	add    $0x9d9bb512,%eax
  400576:	83 c0 01             	add    $0x1,%eax
  400579:	2d 12 b5 9b 9d       	sub    $0x9d9bb512,%eax
  40057e:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400581:	e9 bb ff ff ff       	jmpq   400541 <main+0x41>
  400586:	e9 00 00 00 00       	jmpq   40058b <main+0x8b>
  40058b:	31 c0                	xor    %eax,%eax
  40058d:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  400590:	89 c2                	mov    %eax,%edx
  400592:	29 ca                	sub    %ecx,%edx
  400594:	89 c1                	mov    %eax,%ecx
  400596:	83 e9 01             	sub    $0x1,%ecx
  400599:	01 ca                	add    %ecx,%edx
  40059b:	29 d0                	sub    %edx,%eax
  40059d:	89 45 ec             	mov    %eax,-0x14(%rbp)
  4005a0:	e9 7f ff ff ff       	jmpq   400524 <main+0x24>
  4005a5:	48 bf 54 06 40 00 00 	movabs $0x400654,%rdi
  4005ac:	00 00 00 
  4005af:	8b 75 e4             	mov    -0x1c(%rbp),%esi
  4005b2:	b0 00                	mov    $0x0,%al
  4005b4:	e8 47 fe ff ff       	callq  400400 <printf@plt>
  4005b9:	31 f6                	xor    %esi,%esi
  4005bb:	89 45 e0             	mov    %eax,-0x20(%rbp)
  4005be:	89 f0                	mov    %esi,%eax
  4005c0:	48 83 c4 20          	add    $0x20,%rsp
  4005c4:	5d                   	pop    %rbp
  4005c5:	c3                   	retq   
