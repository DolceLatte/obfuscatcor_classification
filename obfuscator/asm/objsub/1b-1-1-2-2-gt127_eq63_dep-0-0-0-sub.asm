...
./sub//1b-1-1-2-2-gt127_eq63_dep-0-0-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40054b:	e9 0c 00 00 00       	jmpq   40055c <main+0x5c>
  400550:	0f b6 45 ee          	movzbl -0x12(%rbp),%eax
  400554:	c1 e0 01             	shl    $0x1,%eax
  400557:	88 c1                	mov    %al,%cl
  400559:	88 4d ef             	mov    %cl,-0x11(%rbp)
  40055c:	0f b6 45 ef          	movzbl -0x11(%rbp),%eax
  400560:	83 f8 3f             	cmp    $0x3f,%eax
  400563:	0f 85 19 00 00 00    	jne    400582 <main+0x82>
  400569:	48 bf 24 06 40 00 00 	movabs $0x400624,%rdi
  400570:	00 00 00 
  ...
  400582:	48 bf 2e 06 40 00 00 	movabs $0x40062e,%rdi
  400589:	00 00 00 
  40058c:	b0 00                	mov    $0x0,%al
  40058e:	e8 6d fe ff ff       	callq  400400 <printf@plt>
  400593:	89 45 e0             	mov    %eax,-0x20(%rbp)
  400596:	31 c0                	xor    %eax,%eax
  400598:	48 83 c4 20          	add    $0x20,%rsp
  40059c:	5d                   	pop    %rbp
  40059d:	c3                   	retq   
