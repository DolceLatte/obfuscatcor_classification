...
./sub//1b-1-2-1-1-gtsum127_dep-1-0-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400534:	0f 8d 4a 00 00 00    	jge    400584 <main+0x84>
  40053a:	81 7d e8 c0 1f 00 00 	cmpl   $0x1fc0,-0x18(%rbp)
  400541:	0f 8e 0f 00 00 00    	jle    400556 <main+0x56>
  400547:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40054a:	0f af 45 e8          	imul   -0x18(%rbp),%eax
  40054e:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400551:	e9 0f 00 00 00       	jmpq   400565 <main+0x65>
  400556:	31 c0                	xor    %eax,%eax
  400558:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40055b:	8b 55 e8             	mov    -0x18(%rbp),%edx
  40055e:	29 c8                	sub    %ecx,%eax
  400560:	29 c2                	sub    %eax,%edx
  400562:	89 55 e8             	mov    %edx,-0x18(%rbp)
  ...
  400571:	29 ca                	sub    %ecx,%edx
  400573:	89 c1                	mov    %eax,%ecx
  400575:	83 e9 01             	sub    $0x1,%ecx
  400578:	01 ca                	add    %ecx,%edx
  40057a:	29 d0                	sub    %edx,%eax
  40057c:	89 45 ec             	mov    %eax,-0x14(%rbp)
  40057f:	e9 a0 ff ff ff       	jmpq   400524 <main+0x24>
  400584:	48 bf 34 06 40 00 00 	movabs $0x400634,%rdi
  40058b:	00 00 00 
  40058e:	8b 75 e8             	mov    -0x18(%rbp),%esi
  400591:	b0 00                	mov    $0x0,%al
  400593:	e8 68 fe ff ff       	callq  400400 <printf@plt>
  400598:	31 f6                	xor    %esi,%esi
  40059a:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  40059d:	89 f0                	mov    %esi,%eax
  40059f:	48 83 c4 20          	add    $0x20,%rsp
  4005a3:	5d                   	pop    %rbp
  4005a4:	c3                   	retq   
