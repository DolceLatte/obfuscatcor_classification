...
./sub//1b-1-1-0-0-dc-2-0-2-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40053c:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40053f:	8b 55 e8             	mov    -0x18(%rbp),%edx
  400542:	89 c6                	mov    %eax,%esi
  400544:	29 d6                	sub    %edx,%esi
  400546:	89 c2                	mov    %eax,%edx
  400548:	29 ca                	sub    %ecx,%edx
  40054a:	01 d6                	add    %edx,%esi
  40054c:	29 f0                	sub    %esi,%eax
  ...
  400566:	e9 b9 ff ff ff       	jmpq   400524 <main+0x24>
  40056b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
  400572:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400575:	48 8b 4d f0          	mov    -0x10(%rbp),%rcx
  400579:	48 8b 49 08          	mov    0x8(%rcx),%rcx
  40057d:	0f be 11             	movsbl (%rcx),%edx
  400580:	39 d0                	cmp    %edx,%eax
  400582:	0f 8d 2f 00 00 00    	jge    4005b7 <main+0xb7>
  400588:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40058b:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  40058e:	81 e9 58 36 47 86    	sub    $0x86473658,%ecx
  400594:	01 c1                	add    %eax,%ecx
  400596:	81 c1 58 36 47 86    	add    $0x86473658,%ecx
  40059c:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  40059f:	8b 45 ec             	mov    -0x14(%rbp),%eax
  4005a2:	2d d8 ec f7 64       	sub    $0x64f7ecd8,%eax
  4005a7:	83 c0 01             	add    $0x1,%eax
  4005aa:	05 d8 ec f7 64       	add    $0x64f7ecd8,%eax
  4005af:	89 45 ec             	mov    %eax,-0x14(%rbp)
  4005b2:	e9 bb ff ff ff       	jmpq   400572 <main+0x72>
  4005b7:	48 bf 64 06 40 00 00 	movabs $0x400664,%rdi
  4005be:	00 00 00 
