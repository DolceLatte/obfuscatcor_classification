...
./sub//fnvhash-sub.o:     file format elf64-x86-64
...
0000000000400540 <FNVHash>:
  ...
  40056d:	0f 83 4d 00 00 00    	jae    4005c0 <FNVHash+0x80>
  ...
  400584:	8b 55 ec             	mov    -0x14(%rbp),%edx
  400587:	89 d6                	mov    %edx,%esi
  400589:	83 f6 ff             	xor    $0xffffffff,%esi
  40058c:	89 c7                	mov    %eax,%edi
  40058e:	21 f7                	and    %esi,%edi
  400590:	83 f0 ff             	xor    $0xffffffff,%eax
  400593:	21 c2                	and    %eax,%edx
  400595:	09 d7                	or     %edx,%edi
  400597:	89 7d ec             	mov    %edi,-0x14(%rbp)
  40059a:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  40059e:	48 83 c0 01          	add    $0x1,%rax
  4005a2:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  4005a6:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  4005a9:	81 c1 5f c9 24 e6    	add    $0xe624c95f,%ecx
  4005af:	83 c1 01             	add    $0x1,%ecx
  4005b2:	81 e9 5f c9 24 e6    	sub    $0xe624c95f,%ecx
  4005b8:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  4005bb:	e9 a7 ff ff ff       	jmpq   400567 <FNVHash+0x27>
...
00000000004005d0 <main>:
  ...
  40060e:	e8 2d ff ff ff       	callq  400540 <FNVHash>
  400613:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400616:	81 7d e4 d4 81 3c ee 	cmpl   $0xee3c81d4,-0x1c(%rbp)
