...
./sub//16b-1-1-1-0-dc-1-1-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400540:	48 8b 4d c8          	mov    -0x38(%rbp),%rcx
  ...
  400551:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
  400555:	48 83 c0 01          	add    $0x1,%rax
  400559:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
  40055d:	e9 cf ff ff ff       	jmpq   400531 <main+0x31>
  400562:	83 7d f8 7f          	cmpl   $0x7f,-0x8(%rbp)
  400566:	0f 8e 20 00 00 00    	jle    40058c <main+0x8c>
  40056c:	31 c0                	xor    %eax,%eax
  40056e:	48 8b 4d c8          	mov    -0x38(%rbp),%rcx
  400572:	0f be 11             	movsbl (%rcx),%edx
  400575:	8b 75 e4             	mov    -0x1c(%rbp),%esi
  400578:	89 c7                	mov    %eax,%edi
  40057a:	29 f7                	sub    %esi,%edi
  40057c:	89 c6                	mov    %eax,%esi
  40057e:	29 d6                	sub    %edx,%esi
  400580:	01 f7                	add    %esi,%edi
  400582:	29 f8                	sub    %edi,%eax
  400584:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400587:	e9 0e 00 00 00       	jmpq   40059a <main+0x9a>
  40058c:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
  400590:	0f be 08             	movsbl (%rax),%ecx
  400593:	0f af 4d e4          	imul   -0x1c(%rbp),%ecx
  400597:	89 4d e4             	mov    %ecx,-0x1c(%rbp)
  40059a:	48 bf 44 06 40 00 00 	movabs $0x400644,%rdi
  4005a1:	00 00 00 
  4005a4:	8b 75 e4             	mov    -0x1c(%rbp),%esi
  4005a7:	b0 00                	mov    $0x0,%al
  4005a9:	e8 52 fe ff ff       	callq  400400 <printf@plt>
  4005ae:	31 f6                	xor    %esi,%esi
  4005b0:	89 45 c4             	mov    %eax,-0x3c(%rbp)
  4005b3:	89 f0                	mov    %esi,%eax
  4005b5:	48 83 c4 40          	add    $0x40,%rsp
  4005b9:	5d                   	pop    %rbp
  4005ba:	c3                   	retq   
