...
./sub//printinitials-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400527:	e9 bb 00 00 00       	jmpq   4005e7 <main+0xe7>
  40052c:	48 bf 74 06 40 00 00 	movabs $0x400674,%rdi
  400533:	00 00 00 
  ...
  400549:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  40054d:	0f be 30             	movsbl (%rax),%esi
  400550:	b0 00                	mov    $0x0,%al
  400552:	e8 a9 fe ff ff       	callq  400400 <printf@plt>
  400557:	89 45 e0             	mov    %eax,-0x20(%rbp)
  40055a:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  40055e:	48 63 4d e4          	movslq -0x1c(%rbp),%rcx
  400562:	0f be 14 08          	movsbl (%rax,%rcx,1),%edx
  400566:	83 fa 00             	cmp    $0x0,%edx
  400569:	0f 84 5d 00 00 00    	je     4005cc <main+0xcc>
  40056f:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  400573:	48 63 4d e4          	movslq -0x1c(%rbp),%rcx
  400577:	0f be 14 08          	movsbl (%rax,%rcx,1),%edx
  40057b:	83 fa 20             	cmp    $0x20,%edx
  40057e:	0f 85 36 00 00 00    	jne    4005ba <main+0xba>
  400584:	48 bf 74 06 40 00 00 	movabs $0x400674,%rdi
  40058b:	00 00 00 
  40058e:	31 c0                	xor    %eax,%eax
  400590:	8b 4d e4             	mov    -0x1c(%rbp),%ecx
  400593:	89 c2                	mov    %eax,%edx
  400595:	29 ca                	sub    %ecx,%edx
  400597:	89 c1                	mov    %eax,%ecx
  400599:	83 e9 01             	sub    $0x1,%ecx
  40059c:	01 ca                	add    %ecx,%edx
  40059e:	29 d0                	sub    %edx,%eax
  4005a0:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  4005a3:	48 8b 75 e8          	mov    -0x18(%rbp),%rsi
  4005a7:	4c 63 45 e4          	movslq -0x1c(%rbp),%r8
  4005ab:	42 0f be 34 06       	movsbl (%rsi,%r8,1),%esi
  4005b0:	b0 00                	mov    $0x0,%al
  4005b2:	e8 49 fe ff ff       	callq  400400 <printf@plt>
  4005b7:	89 45 dc             	mov    %eax,-0x24(%rbp)
  4005ba:	31 c0                	xor    %eax,%eax
  4005bc:	8b 4d e4             	mov    -0x1c(%rbp),%ecx
  4005bf:	83 e8 01             	sub    $0x1,%eax
  4005c2:	29 c1                	sub    %eax,%ecx
  4005c4:	89 4d e4             	mov    %ecx,-0x1c(%rbp)
  4005c7:	e9 8e ff ff ff       	jmpq   40055a <main+0x5a>
  4005cc:	48 bf 77 06 40 00 00 	movabs $0x400677,%rdi
  4005d3:	00 00 00 
  4005d6:	b0 00                	mov    $0x0,%al
  4005d8:	e8 23 fe ff ff       	callq  400400 <printf@plt>
  4005dd:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  4005e4:	89 45 d8             	mov    %eax,-0x28(%rbp)
  4005e7:	8b 45 fc             	mov    -0x4(%rbp),%eax
  4005ea:	48 83 c4 30          	add    $0x30,%rsp
  4005ee:	5d                   	pop    %rbp
  4005ef:	c3                   	retq   
