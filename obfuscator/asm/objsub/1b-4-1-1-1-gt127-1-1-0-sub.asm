...
./sub//1b-4-1-1-1-gt127-1-1-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052b:	0f 8e 13 00 00 00    	jle    400544 <main+0x44>
  400531:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400534:	2d 02 d7 05 04       	sub    $0x405d702,%eax
  400539:	83 c0 01             	add    $0x1,%eax
  40053c:	05 02 d7 05 04       	add    $0x405d702,%eax
  400541:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400544:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
  40054b:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40054e:	3b 45 f8             	cmp    -0x8(%rbp),%eax
  400551:	0f 8d 29 00 00 00    	jge    400580 <main+0x80>
  400557:	31 c0                	xor    %eax,%eax
  400559:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40055c:	8b 55 e8             	mov    -0x18(%rbp),%edx
  40055f:	29 c8                	sub    %ecx,%eax
  400561:	29 c2                	sub    %eax,%edx
  400563:	89 55 e8             	mov    %edx,-0x18(%rbp)
  400566:	31 c0                	xor    %eax,%eax
  400568:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40056b:	89 c2                	mov    %eax,%edx
  40056d:	29 ca                	sub    %ecx,%edx
  40056f:	89 c1                	mov    %eax,%ecx
  400571:	83 e9 01             	sub    $0x1,%ecx
  400574:	01 ca                	add    %ecx,%edx
  400576:	29 d0                	sub    %edx,%eax
  400578:	89 45 ec             	mov    %eax,-0x14(%rbp)
  40057b:	e9 cb ff ff ff       	jmpq   40054b <main+0x4b>
  400580:	48 bf 34 06 40 00 00 	movabs $0x400634,%rdi
  400587:	00 00 00 
  40058a:	8b 75 e8             	mov    -0x18(%rbp),%esi
  40058d:	b0 00                	mov    $0x0,%al
  40058f:	e8 6c fe ff ff       	callq  400400 <printf@plt>
  400594:	31 f6                	xor    %esi,%esi
  400596:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400599:	89 f0                	mov    %esi,%eax
  40059b:	48 83 c4 20          	add    $0x20,%rsp
  40059f:	5d                   	pop    %rbp
  4005a0:	c3                   	retq   
