...
./sub//prime-sub.o:     file format elf64-x86-64
...
0000000000400590 <main>:
  ...
  4005b7:	e9 c9 00 00 00       	jmpq   400685 <main+0xf5>
  4005bc:	48 8d 7d d8          	lea    -0x28(%rbp),%rdi
  4005c0:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%rbp)
  ...
  4005e3:	c7 45 e8 02 00 00 00 	movl   $0x2,-0x18(%rbp)
  4005ea:	b8 02 00 00 00       	mov    $0x2,%eax
  4005ef:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  4005f2:	8b 55 ec             	mov    -0x14(%rbp),%edx
  4005f5:	89 45 d4             	mov    %eax,-0x2c(%rbp)
  4005f8:	89 d0                	mov    %edx,%eax
  4005fa:	99                   	cltd   
  4005fb:	8b 75 d4             	mov    -0x2c(%rbp),%esi
  4005fe:	f7 fe                	idiv   %esi
  400600:	39 c1                	cmp    %eax,%ecx
  400602:	0f 8f 39 00 00 00    	jg     400641 <main+0xb1>
  400608:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40060b:	99                   	cltd   
  40060c:	f7 7d e8             	idivl  -0x18(%rbp)
  40060f:	83 fa 00             	cmp    $0x0,%edx
  400612:	0f 85 0c 00 00 00    	jne    400624 <main+0x94>
  400618:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%rbp)
  40061f:	e9 1d 00 00 00       	jmpq   400641 <main+0xb1>
  400624:	e9 00 00 00 00       	jmpq   400629 <main+0x99>
  400629:	8b 45 e8             	mov    -0x18(%rbp),%eax
  40062c:	05 5a 8e 63 68       	add    $0x68638e5a,%eax
  400631:	83 c0 01             	add    $0x1,%eax
  400634:	2d 5a 8e 63 68       	sub    $0x68638e5a,%eax
  400639:	89 45 e8             	mov    %eax,-0x18(%rbp)
  40063c:	e9 a9 ff ff ff       	jmpq   4005ea <main+0x5a>
  400641:	83 7d e4 00          	cmpl   $0x0,-0x1c(%rbp)
  400645:	0f 85 1c 00 00 00    	jne    400667 <main+0xd7>
  40064b:	48 bf 14 07 40 00 00 	movabs $0x400714,%rdi
  400652:	00 00 00 
  400655:	8b 75 ec             	mov    -0x14(%rbp),%esi
  400658:	b0 00                	mov    $0x0,%al
  40065a:	e8 11 fe ff ff       	callq  400470 <printf@plt>
  40065f:	89 45 d0             	mov    %eax,-0x30(%rbp)
  400662:	e9 17 00 00 00       	jmpq   40067e <main+0xee>
  400667:	48 bf 2b 07 40 00 00 	movabs $0x40072b,%rdi
  40066e:	00 00 00 
  400671:	8b 75 ec             	mov    -0x14(%rbp),%esi
  400674:	b0 00                	mov    $0x0,%al
  400676:	e8 f5 fd ff ff       	callq  400470 <printf@plt>
  40067b:	89 45 cc             	mov    %eax,-0x34(%rbp)
  40067e:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  400685:	8b 45 fc             	mov    -0x4(%rbp),%eax
  400688:	48 83 c4 40          	add    $0x40,%rsp
  40068c:	5d                   	pop    %rbp
  40068d:	c3                   	retq   
