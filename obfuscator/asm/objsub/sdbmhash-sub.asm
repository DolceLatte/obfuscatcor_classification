...
./sub//sdbmhash-sub.o:     file format elf64-x86-64
...
0000000000400540 <SDBMHash>:
  ...
  400566:	0f 83 61 00 00 00    	jae    4005cd <SDBMHash+0x8d>
  40056c:	31 c0                	xor    %eax,%eax
  40056e:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
  400572:	0f be 11             	movsbl (%rcx),%edx
  400575:	8b 75 f0             	mov    -0x10(%rbp),%esi
  400578:	c1 e6 06             	shl    $0x6,%esi
  40057b:	81 ea e1 81 8c fc    	sub    $0xfc8c81e1,%edx
  400581:	01 f2                	add    %esi,%edx
  400583:	81 c2 e1 81 8c fc    	add    $0xfc8c81e1,%edx
  400589:	8b 75 f0             	mov    -0x10(%rbp),%esi
  40058c:	c1 e6 10             	shl    $0x10,%esi
  40058f:	29 f0                	sub    %esi,%eax
  400591:	29 c2                	sub    %eax,%edx
  400593:	8b 45 f0             	mov    -0x10(%rbp),%eax
  400596:	81 ea 5a 7f 45 b6    	sub    $0xb6457f5a,%edx
  40059c:	29 c2                	sub    %eax,%edx
  40059e:	81 c2 5a 7f 45 b6    	add    $0xb6457f5a,%edx
  4005a4:	89 55 f0             	mov    %edx,-0x10(%rbp)
  4005a7:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
  4005ab:	48 83 c0 01          	add    $0x1,%rax
  4005af:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  4005b3:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  4005b6:	81 c1 66 ca 19 cc    	add    $0xcc19ca66,%ecx
  4005bc:	83 c1 01             	add    $0x1,%ecx
  4005bf:	81 e9 66 ca 19 cc    	sub    $0xcc19ca66,%ecx
  4005c5:	89 4d ec             	mov    %ecx,-0x14(%rbp)
  4005c8:	e9 93 ff ff ff       	jmpq   400560 <SDBMHash+0x20>
  4005cd:	8b 45 f0             	mov    -0x10(%rbp),%eax
  4005d0:	5d                   	pop    %rbp
  4005d1:	c3                   	retq   
...
00000000004005e0 <main>:
  ...
  40061e:	e8 1d ff ff ff       	callq  400540 <SDBMHash>
  400623:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400626:	81 7d e4 6e d6 dc 89 	cmpl   $0x89dcd66e,-0x1c(%rbp)
