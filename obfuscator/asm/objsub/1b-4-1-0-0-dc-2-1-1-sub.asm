...
./sub//1b-4-1-0-0-dc-2-1-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	0f 8d 31 00 00 00    	jge    400561 <main+0x61>
  400530:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400533:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  400536:	81 c1 08 47 5f 99    	add    $0x995f4708,%ecx
  40053c:	01 c1                	add    %eax,%ecx
  40053e:	81 e9 08 47 5f 99    	sub    $0x995f4708,%ecx
  400544:	89 4d e8             	mov    %ecx,-0x18(%rbp)
  400547:	31 c0                	xor    %eax,%eax
  400549:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  40054c:	89 c2                	mov    %eax,%edx
  40054e:	29 ca                	sub    %ecx,%edx
  400550:	89 c1                	mov    %eax,%ecx
  400552:	83 e9 01             	sub    $0x1,%ecx
  400555:	01 ca                	add    %ecx,%edx
  400557:	29 d0                	sub    %edx,%eax
  400559:	89 45 ec             	mov    %eax,-0x14(%rbp)
  40055c:	e9 c3 ff ff ff       	jmpq   400524 <main+0x24>
  400561:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
  400568:	8b 45 ec             	mov    -0x14(%rbp),%eax
  40056b:	48 8b 4d f0          	mov    -0x10(%rbp),%rcx
  40056f:	48 8b 49 08          	mov    0x8(%rcx),%rcx
  400573:	0f be 11             	movsbl (%rcx),%edx
  400576:	39 d0                	cmp    %edx,%eax
  400578:	0f 8f 27 00 00 00    	jg     4005a5 <main+0xa5>
  40057e:	31 c0                	xor    %eax,%eax
  400580:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  400583:	8b 55 e8             	mov    -0x18(%rbp),%edx
  400586:	29 c8                	sub    %ecx,%eax
  400588:	29 c2                	sub    %eax,%edx
  40058a:	89 55 e8             	mov    %edx,-0x18(%rbp)
  40058d:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400590:	05 cb 64 9a d2       	add    $0xd29a64cb,%eax
  400595:	83 c0 01             	add    $0x1,%eax
  400598:	2d cb 64 9a d2       	sub    $0xd29a64cb,%eax
  40059d:	89 45 ec             	mov    %eax,-0x14(%rbp)
  4005a0:	e9 c3 ff ff ff       	jmpq   400568 <main+0x68>
  4005a5:	48 bf 54 06 40 00 00 	movabs $0x400654,%rdi
  4005ac:	00 00 00 
  4005af:	8b 75 e8             	mov    -0x18(%rbp),%esi
