...
./sub//1b-1-2-1-1-eq127-1-0-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400534:	0f 8d 51 00 00 00    	jge    40058b <main+0x8b>
  ...
  400548:	0f 85 14 00 00 00    	jne    400562 <main+0x62>
  40054e:	31 c0                	xor    %eax,%eax
  400550:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  400553:	8b 55 e8             	mov    -0x18(%rbp),%edx
  400556:	29 c8                	sub    %ecx,%eax
  400558:	29 c2                	sub    %eax,%edx
  40055a:	89 55 e8             	mov    %edx,-0x18(%rbp)
  40055d:	e9 0a 00 00 00       	jmpq   40056c <main+0x6c>
  400562:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400565:	0f af 45 e8          	imul   -0x18(%rbp),%eax
  400569:	89 45 e8             	mov    %eax,-0x18(%rbp)
  40056c:	e9 00 00 00 00       	jmpq   400571 <main+0x71>
  400571:	31 c0                	xor    %eax,%eax
  400573:	8b 4d ec             	mov    -0x14(%rbp),%ecx
  400576:	89 c2                	mov    %eax,%edx
  400578:	29 ca                	sub    %ecx,%edx
  40057a:	89 c1                	mov    %eax,%ecx
  40057c:	83 e9 01             	sub    $0x1,%ecx
  40057f:	01 ca                	add    %ecx,%edx
  400581:	29 d0                	sub    %edx,%eax
  400583:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400586:	e9 99 ff ff ff       	jmpq   400524 <main+0x24>
  40058b:	48 bf 34 06 40 00 00 	movabs $0x400634,%rdi
  400592:	00 00 00 
  400595:	8b 75 e8             	mov    -0x18(%rbp),%esi
  400598:	b0 00                	mov    $0x0,%al
  40059a:	e8 61 fe ff ff       	callq  400400 <printf@plt>
  40059f:	31 f6                	xor    %esi,%esi
  4005a1:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  4005a4:	89 f0                	mov    %esi,%eax
  4005a6:	48 83 c4 20          	add    $0x20,%rsp
  4005aa:	5d                   	pop    %rbp
  4005ab:	c3                   	retq   
