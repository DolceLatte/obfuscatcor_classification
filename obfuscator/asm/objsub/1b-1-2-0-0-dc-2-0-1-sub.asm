...
./sub//1b-1-2-0-0-dc-2-0-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400528:	0f 8d 69 00 00 00    	jge    400597 <main+0x97>
  40052e:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%rbp)
  400535:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400538:	48 8b 4d f0          	mov    -0x10(%rbp),%rcx
  40053c:	48 8b 49 08          	mov    0x8(%rcx),%rcx
  400540:	0f be 11             	movsbl (%rcx),%edx
  400543:	39 d0                	cmp    %edx,%eax
  400545:	0f 8d 2f 00 00 00    	jge    40057a <main+0x7a>
  40054b:	31 c0                	xor    %eax,%eax
  40054d:	8b 4d e8             	mov    -0x18(%rbp),%ecx
  400550:	8b 55 e4             	mov    -0x1c(%rbp),%edx
  400553:	89 c6                	mov    %eax,%esi
  400555:	29 d6                	sub    %edx,%esi
  400557:	89 c2                	mov    %eax,%edx
  400559:	29 ca                	sub    %ecx,%edx
  40055b:	01 d6                	add    %edx,%esi
  40055d:	29 f0                	sub    %esi,%eax
  40055f:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400562:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400565:	2d db 7d 20 59       	sub    $0x59207ddb,%eax
  40056a:	83 c0 01             	add    $0x1,%eax
  40056d:	05 db 7d 20 59       	add    $0x59207ddb,%eax
  400572:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400575:	e9 bb ff ff ff       	jmpq   400535 <main+0x35>
  40057a:	e9 00 00 00 00       	jmpq   40057f <main+0x7f>
  40057f:	8b 45 ec             	mov    -0x14(%rbp),%eax
  400582:	2d d6 f4 37 cd       	sub    $0xcd37f4d6,%eax
  400587:	83 c0 01             	add    $0x1,%eax
  40058a:	05 d6 f4 37 cd       	add    $0xcd37f4d6,%eax
  40058f:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400592:	e9 8d ff ff ff       	jmpq   400524 <main+0x24>
  400597:	48 bf 44 06 40 00 00 	movabs $0x400644,%rdi
  40059e:	00 00 00 
  4005a1:	8b 75 e4             	mov    -0x1c(%rbp),%esi
  4005a4:	b0 00                	mov    $0x0,%al
  4005a6:	e8 55 fe ff ff       	callq  400400 <printf@plt>
  4005ab:	31 f6                	xor    %esi,%esi
  4005ad:	89 45 e0             	mov    %eax,-0x20(%rbp)
  4005b0:	89 f0                	mov    %esi,%eax
  4005b2:	48 83 c4 20          	add    $0x20,%rsp
  4005b6:	5d                   	pop    %rbp
  4005b7:	c3                   	retq   
