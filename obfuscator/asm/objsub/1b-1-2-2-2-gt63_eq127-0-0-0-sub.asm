...
./sub//1b-1-2-2-2-gt63_eq127-0-0-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400530:	48 bf 24 06 40 00 00 	movabs $0x400624,%rdi
  400537:	00 00 00 
  ...
  400551:	48 bf 2e 06 40 00 00 	movabs $0x40062e,%rdi
  400558:	00 00 00 
  ...
  40056a:	48 bf 38 06 40 00 00 	movabs $0x400638,%rdi
  400571:	00 00 00 
  400574:	b0 00                	mov    $0x0,%al
  400576:	e8 85 fe ff ff       	callq  400400 <printf@plt>
  40057b:	89 45 e0             	mov    %eax,-0x20(%rbp)
  40057e:	e9 14 00 00 00       	jmpq   400597 <main+0x97>
  400583:	48 bf 43 06 40 00 00 	movabs $0x400643,%rdi
  40058a:	00 00 00 
  40058d:	b0 00                	mov    $0x0,%al
  40058f:	e8 6c fe ff ff       	callq  400400 <printf@plt>
  400594:	89 45 dc             	mov    %eax,-0x24(%rbp)
  400597:	31 c0                	xor    %eax,%eax
  400599:	48 83 c4 30          	add    $0x30,%rsp
  40059d:	5d                   	pop    %rbp
  40059e:	c3                   	retq   
  40059f:	90                   	nop
