...
./sub//1b-1-2-2-2-gt63_gt127_dep-0-0-0-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  40052a:	0f 8e 6b 00 00 00    	jle    40059b <main+0x9b>
  400530:	48 bf 44 06 40 00 00 	movabs $0x400644,%rdi
  400537:	00 00 00 
  40053a:	b0 00                	mov    $0x0,%al
  40053c:	e8 bf fe ff ff       	callq  400400 <printf@plt>
  400541:	b9 03 00 00 00       	mov    $0x3,%ecx
  400546:	0f b6 55 ef          	movzbl -0x11(%rbp),%edx
  40054a:	89 45 e8             	mov    %eax,-0x18(%rbp)
  40054d:	89 d0                	mov    %edx,%eax
  40054f:	99                   	cltd   
  400550:	f7 f9                	idiv   %ecx
  400552:	c1 e0 01             	shl    $0x1,%eax
  400555:	40 88 c6             	mov    %al,%sil
  400558:	40 88 75 ee          	mov    %sil,-0x12(%rbp)
  40055c:	0f b6 45 ef          	movzbl -0x11(%rbp),%eax
  400560:	83 f8 7f             	cmp    $0x7f,%eax
  400563:	0f 8e 19 00 00 00    	jle    400582 <main+0x82>
  400569:	48 bf 4e 06 40 00 00 	movabs $0x40064e,%rdi
  400570:	00 00 00 
  400573:	b0 00                	mov    $0x0,%al
  400575:	e8 86 fe ff ff       	callq  400400 <printf@plt>
  40057a:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  40057d:	e9 14 00 00 00       	jmpq   400596 <main+0x96>
  400582:	48 bf 58 06 40 00 00 	movabs $0x400658,%rdi
  400589:	00 00 00 
  40058c:	b0 00                	mov    $0x0,%al
  40058e:	e8 6d fe ff ff       	callq  400400 <printf@plt>
  400593:	89 45 e0             	mov    %eax,-0x20(%rbp)
  400596:	e9 14 00 00 00       	jmpq   4005af <main+0xaf>
  40059b:	48 bf 63 06 40 00 00 	movabs $0x400663,%rdi
  4005a2:	00 00 00 
  4005a5:	b0 00                	mov    $0x0,%al
  4005a7:	e8 54 fe ff ff       	callq  400400 <printf@plt>
  4005ac:	89 45 dc             	mov    %eax,-0x24(%rbp)
  4005af:	31 c0                	xor    %eax,%eax
  4005b1:	48 83 c4 30          	add    $0x30,%rsp
  4005b5:	5d                   	pop    %rbp
  4005b6:	c3                   	retq   
