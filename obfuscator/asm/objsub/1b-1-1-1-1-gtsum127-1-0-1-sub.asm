...
./sub//1b-1-1-1-1-gtsum127-1-0-1-sub.o:     file format elf64-x86-64
...
0000000000400500 <main>:
  ...
  400534:	0f 8d 2f 00 00 00    	jge    400569 <main+0x69>
  ...
  400554:	05 9c 3e 5a 18       	add    $0x185a3e9c,%eax
  400559:	83 c0 01             	add    $0x1,%eax
  40055c:	2d 9c 3e 5a 18       	sub    $0x185a3e9c,%eax
  400561:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400564:	e9 bb ff ff ff       	jmpq   400524 <main+0x24>
  400569:	81 7d e8 c0 1f 00 00 	cmpl   $0x1fc0,-0x18(%rbp)
  400570:	0f 8e 1c 00 00 00    	jle    400592 <main+0x92>
  400576:	48 bf 44 06 40 00 00 	movabs $0x400644,%rdi
  40057d:	00 00 00 
  400580:	8b 75 e8             	mov    -0x18(%rbp),%esi
  400583:	b0 00                	mov    $0x0,%al
  400585:	e8 76 fe ff ff       	callq  400400 <printf@plt>
  40058a:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  40058d:	e9 17 00 00 00       	jmpq   4005a9 <main+0xa9>
  400592:	48 bf 44 06 40 00 00 	movabs $0x400644,%rdi
  400599:	00 00 00 
  40059c:	8b 75 e8             	mov    -0x18(%rbp),%esi
  40059f:	b0 00                	mov    $0x0,%al
  4005a1:	e8 5a fe ff ff       	callq  400400 <printf@plt>
  4005a6:	89 45 e0             	mov    %eax,-0x20(%rbp)
  4005a9:	31 c0                	xor    %eax,%eax
  4005ab:	48 83 c4 20          	add    $0x20,%rsp
  4005af:	5d                   	pop    %rbp
  4005b0:	c3                   	retq   
