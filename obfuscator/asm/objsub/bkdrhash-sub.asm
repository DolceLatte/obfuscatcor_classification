...
./sub//bkdrhash-sub.o:     file format elf64-x86-64
...
0000000000400540 <BKDRHash>:
  ...
  40056d:	0f 83 43 00 00 00    	jae    4005b6 <BKDRHash+0x76>
  ...
  400581:	05 11 3d 93 b2       	add    $0xb2933d11,%eax
  400586:	01 d0                	add    %edx,%eax
  400588:	2d 11 3d 93 b2       	sub    $0xb2933d11,%eax
  40058d:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400590:	31 c0                	xor    %eax,%eax
  400592:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
  400596:	48 83 c1 01          	add    $0x1,%rcx
  40059a:	48 89 4d f8          	mov    %rcx,-0x8(%rbp)
  40059e:	8b 55 e8             	mov    -0x18(%rbp),%edx
  4005a1:	89 c6                	mov    %eax,%esi
  4005a3:	29 d6                	sub    %edx,%esi
  4005a5:	89 c2                	mov    %eax,%edx
  4005a7:	83 ea 01             	sub    $0x1,%edx
  4005aa:	01 d6                	add    %edx,%esi
  4005ac:	29 f0                	sub    %esi,%eax
  4005ae:	89 45 e8             	mov    %eax,-0x18(%rbp)
  4005b1:	e9 b1 ff ff ff       	jmpq   400567 <BKDRHash+0x27>
...
00000000004005c0 <main>:
  ...
  4005fe:	e8 3d ff ff ff       	callq  400540 <BKDRHash>
  400603:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  400606:	81 7d e4 b2 82 92 bd 	cmpl   $0xbd9282b2,-0x1c(%rbp)
